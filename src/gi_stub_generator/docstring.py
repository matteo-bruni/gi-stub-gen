...
# from gi._gi import (  # pyright: ignore[reportMissingImports]
#     VFuncInfo,
#     FunctionInfo,
#     CallableInfo,
#     ObjectInfo,
...
#     in_args_strs = []
#     if isinstance(info, VFuncInfo):  # virtual function has to be a method ??
#         in_args_strs = ["self"]
#     elif isinstance(info, FunctionInfo):
#         if info.is_method():
#             in_args_strs = ["self"]  # method

#     args = info.get_arguments()
#     hint_blacklist = ("void",)

#     # GI.ArgInfo.get_destroy
#     # Obtains the index of the DestroyNotify argument.
#     # This is only valid for arguments which are callbacks.

#     # GI.ArgInfo.get_closure
