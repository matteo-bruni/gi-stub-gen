...
class ByteArray(GObject.GBoxed, metaclass=GObject.GType):
    ...
    # gi Methods
    @staticmethod
    def append(array: list, data: int, len: int) -> list:
        """
            Adds the given bytes to the end of the GByteArray.
        The array will grow in size automatically if necessary.
        """
    ...
    def free(array: list, free_segment: bool) -> int:
        ...
        """
    @staticmethod
    def free_to_bytes(array: list) -> Bytes:
        """
            Transfers the data from the GByteArray into a new immutable GBytes.
    ...
    def new() -> list:
        ...
        """
    @staticmethod
    def new_take(data: list, len: int) -> list:
        """
            Creates a byte array containing the `data`.
        After this call, `data` belongs to the GByteArray and may no longer be
        modified by the caller. The memory of `data` has to be dynamically
        ...
        """
    @staticmethod
    def prepend(array: list, data: int, len: int) -> list:
        """
            Adds the given data to the start of the GByteArray.
        The array will grow in size automatically if necessary.
        """
    @staticmethod
    def ref(array: list) -> list:
        """
            Atomically increments the reference count of `array` by one.
        This function is thread-safe and may be called from any thread.
        """
    @staticmethod
    def remove_index(array: list, index_: int) -> list:
        """
            Removes the byte at the given index from a GByteArray.
        The following bytes are moved down one place.
        """
    @staticmethod
    def remove_index_fast(array: list, index_: int) -> list:
        """
            Removes the byte at the given index from a GByteArray. The last
        element in the array is used to fill in the space, so this function
        does not preserve the order of the GByteArray. But it is faster
        ...
        """
    @staticmethod
    def remove_range(array: list, index_: int, length: int) -> list:
        """
            Removes the given number of bytes starting at the given index from a
        GByteArray.  The following elements are moved to close the gap.
        """
    @staticmethod
    def set_size(array: list, length: int) -> list:
        """
        Sets the size of the GByteArray, expanding it if necessary.
        """
    @staticmethod
    def sized_new(reserved_size: int) -> list:
        """
            Creates a new GByteArray with `reserved_size` bytes preallocated.
        This avoids frequent reallocation, if you are going to add many
        bytes to the array. Note however that the size of the array is still
        ...
        """
    @staticmethod
    def sort(array: list, compare_func: CompareFunc) -> None:
        """
            Sorts a byte array, using `compare_func` which should be a
        `qsort`-style comparison function (returns less than zero for first
        arg is less than second arg, zero for equal, greater than zero if
        ...
        """
    @staticmethod
    def sort_with_data(array: list, compare_func: CompareDataFunc, *user_data: object | None) -> None:
        """
            Like `g_byte_array_sort`, but the comparison function takes an extra
        user data argument.
        """
    @staticmethod
    def steal(array: list) -> tuple[int, int]:
        """
            Frees the data in the array and resets the size to zero, while
        the underlying array is preserved for use elsewhere and returned
        to the caller.
