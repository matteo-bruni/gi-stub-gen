...
def idle_add(
    function: collections.abc.Callable[..., types.UnionType[bool, NoneType]],
...
def markup_escape_text(
    text: types.UnionType[str, bytes],
    length: int = -1,
) -> str: ...
...
class Error(builtins.RuntimeError, metaclass=GObject.GType):
    ...
    def matches(
        self,
        domain: types.UnionType[str, int],
        code: int,
    ) -> bool: ...
    @staticmethod
    def new_literal(
...
class IOChannel(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def writelines(
        self,
        lines: collections.abc.Iterable[types.UnionType[str, bytes]],
    ) -> None: ...
...
class Variant(GObject.GPointer, metaclass=GObject.GType):
    ...
    def keys(
        self,
    ) -> collections.abc.Iterable[types.UnionType[bool, float, str]]: ...
    @classmethod
    def new_array(
        cls,
