...
def hash_table_new_similar(
    other_hash_table: dict[object, object],
) -> dict[object, object]:
    """
...
def hash_table_steal_extended(
    ...
    key and the value from such a dictionary, the value will be None.
    """
    ...
...
def strcmp0(
    ...
    """
    Compares `str1` and `str2` like `strcmp`. Handles None
    gracefully by sorting it before non-None strings.
...
def test_trap_subprocess(
    ...
    set to None. See the documentation for that function for full details.
    """
    ...
...
def utf8_validate(
    ...
    If `end` is non-None, then the end of the valid range
...
class IOCondition(GObject.GFlags, enum.IntFlag):
    """
...
class NormalizeMode(GObject.GEnum, enum.IntEnum):
    """
...
class UnicodeBreakType(GObject.GEnum, enum.IntEnum):
    """
...
class UnicodeScript(GObject.GEnum, enum.IntEnum):
    """
...
class UnicodeType(GObject.GEnum, enum.IntEnum):
    """
...
class ByteArray(GObject.GBoxed, metaclass=GObject.GType):
    ...
    # gi Methods
    @staticmethod
    def append(array: bytes, data: int, len: int) -> bytes:
        """
            Adds the given bytes to the end of the GByteArray.
        The array will grow in size automatically if necessary.
        """
    @staticmethod
    def free(array: bytes, free_segment: bool) -> int:
        """
            Frees the memory allocated by the GByteArray. If `free_segment` is
        True it frees the actual byte data. If the reference count of
        `array` is greater than one, the GByteArray wrapper is preserved but
    ...
    def new_take(data: bytes) -> bytes:
        ...
        """
    @staticmethod
    def prepend(array: bytes, data: int, len: int) -> bytes:
        """
            Adds the given data to the start of the GByteArray.
        The array will grow in size automatically if necessary.
        """
    ...
    def sort_with_data(array: bytes, compare_func: CompareDataFunc, *user_data: object | None) -> None:
        ...
        """
    @staticmethod
    def steal(array: bytes) -> tuple[int, int]:
        """
            Frees the data in the array and resets the size to zero, while
        the underlying array is preserved for use elsewhere and returned
        to the caller.
...
class Bytes(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def equal(self, bytes2: Bytes) -> bool:
        ...
        parameter, when using non-None GBytes pointers as keys in a GHashTable.
        """
    ...
    def unref(self) -> None:
        ...
        freed. If `bytes` is None, it will return immediately.
        """
...
class HashTableIter(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Methods
    def get_hash_table(self) -> dict[object, object]:
        """
        Returns the GHashTable associated with `iter`.
        """
    def init(self, hash_table: dict[object, object]) -> None:
        """
...
class IOChannel(GObject.GBoxed, metaclass=GObject.GType):
    ...
    @builtins.property
    def partial_write_buf(self) -> list[int] | None: ...
    @builtins.property
    ...
    def writelines(
        self,
        lines: collections.abc.Iterable[str | bytes],
    ) -> None: ...
...
class KeyFile(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def get_boolean(self, group_name: str, key: str) -> bool:
        ...
        """
    def get_boolean_list(self, group_name: str, key: str) -> tuple[list[bool], int]:
        """
    ...
    def get_double(self, group_name: str, key: str) -> float:
        ...
        and `error` is set to G_KEY_FILE_ERROR_INVALID_VALUE.
        """
    def get_double_list(self, group_name: str, key: str) -> tuple[list[float], int]:
        """
            Returns the values associated with `key` under `group_name` as
        doubles.
    ...
    def get_integer(self, group_name: str, key: str) -> int:
        ...
        and `error` is set to G_KEY_FILE_ERROR_INVALID_VALUE.
        """
    def get_integer_list(self, group_name: str, key: str) -> tuple[list[int], int]:
        """
            Returns the values associated with `key` under `group_name` as
        integers.
    ...
    def get_locale_string(self, group_name: str, key: str, locale: str | None = None) -> str:
        ...
        """
    def get_locale_string_list(self, group_name: str, key: str, locale: str | None = None) -> tuple[list[str], int]:
        """
    ...
    def get_string(self, group_name: str, key: str) -> str:
        ...
        """
    def get_string_list(self, group_name: str, key: str) -> tuple[list[str], int]:
        """
            Returns the values associated with `key` under `group_name`.
    ...
    def load_from_data_dirs(self, file: str, flags: KeyFileFlags) -> tuple[bool, str]:
        ...
        """
    def load_from_dirs(self, file: str, search_dirs: list[str], flags: KeyFileFlags) -> tuple[bool, str]:
        """
            This function looks for a key file named `file` in the paths
...
class OptionContext(GObject.GPointer, metaclass=GObject.GType):
    ...
    def add_group(self, group: OptionGroup) -> None:
        ...
        """
    def add_main_entries(self, entries: list[OptionEntry], translation_domain: str | None = None) -> None:
        """
    ...
    def get_summary(self) -> str:
        ...
        """
    def parse(self, argv: list[str] | None = None) -> tuple[bool, list[str] | None]:
        """
        ...
        arguments.
        """
    def parse_strv(self, arguments: list[str] | None = None) -> tuple[bool, list[str] | None]:
        """
...
class PathBuf(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Fields
    @builtins.property
    def dummy(self) -> list[object] | None: ...
...
class Private(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Fields
    @builtins.property
    def future(self) -> list[object] | None: ...
    @builtins.property
...
class Scanner(GObject.GPointer, metaclass=GObject.GType):
    ...
    @builtins.property
    def symbol_table(self) -> dict[object, object] | None: ...
    @builtins.property
    def text(self) -> str: ...
    @builtins.property
...
class Source(GObject.GBoxed, metaclass=GObject.GType):
    ...
    @builtins.property
    def poll_fds(self) -> list[object] | None: ...
    @builtins.property
...
class SourceFuncs(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Fields
    @builtins.property
    def check(self) -> checkSourceFuncsCB:
        """
    ...
    def dispatch(self) -> object | None:
        ...
        """
    @builtins.property
    def finalize(self) -> finalizeSourceFuncsCB:
        """
        ...
        """
    @builtins.property
    def prepare(self) -> prepareSourceFuncsCB:
        """
...
class TestLogBuffer(GObject.GPointer, metaclass=GObject.GType):
    ...
    @builtins.property
    def msgs(self) -> list[object] | None: ...
...
class Tree(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def new_full(
        cls,
        key_compare_func: collections.abc.Callable[[typing.Any, typing.Any, typing.Any], int],
        key_compare_data: typing.Any,
        key_destroy_func: collections.abc.Callable[[typing.Any], None],
    ) -> Tree:
        """
        [is-override: Note this method is an override in Python of the original gi implementation.]
...
class UnixPipe(GObject.GPointer, metaclass=GObject.GType):
    """
...
class Variant(GObject.GPointer, metaclass=GObject.GType):
    ...
    def dup_bytestring(self) -> tuple[bytes, int]:
        ...
        """
    def dup_bytestring_array(self) -> tuple[list[str], int]:
        """
        ...
        """
    def dup_objv(self) -> tuple[list[str], int]:
        """
    ...
    def dup_string(self) -> tuple[str, int]:
        ...
        The return value must be freed using `g_free`.
        """
    def dup_strv(self) -> tuple[list[str], int]:
        """
    ...
    def get_bytestring(self) -> bytes:
        ...
        """
    def get_bytestring_array(self) -> tuple[list[str], int]:
        """
            Gets the contents of an array of array of bytes GVariant.  This call
    ...
    def get_normal_form(self) -> Variant:
        ...
        reference to it.
        """
    def get_objv(self) -> tuple[list[str], int]:
        """
            Gets the contents of an array of object paths GVariant.  This call
        makes a shallow copy; the return result should be released with
        `g_free`, but the individual strings must not be modified.
    ...
    def get_size(self) -> int:
        ...
        involved.
        """
    def get_strv(self) -> tuple[list[str], int]:
        """
            Gets the contents of an array of strings GVariant.  This call
        makes a shallow copy; the return result should be released with
        `g_free`, but the individual strings must not be modified.
    ...
    def keys(
        self,
    ) -> collections.abc.Iterable[bool | float | str]: ...
    @classmethod
    def new_array(
        cls,
    ...
    def new_from_data(
        ...
        data: list[int],
        trusted: bool,
        notify: collections.abc.Callable[[typing.Any], None],
        user_data: typing.Any = None,
    ) -> Variant:
        """
        [is-override: Note this method is an override in Python of the original gi implementation.]
...
class VariantType(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def copy(self) -> VariantType:
        ...
        `g_variant_type_free` on the return value.  `type` may not be None.
        """
...
class CompletionFunc(typing.Protocol):
    """
    This callback was used in:
        Completion.func
    """
...
class CompletionStrncmpFunc(typing.Protocol):
    """
    This callback was used in:
...
class HookFinalizeFunc(typing.Protocol):
    """
    This callback was used in:
...
class SourceFunc(typing.Protocol):
    """
    This callback was used in:
        GLib.invoke_full, GLib.set_callback, GLib.unix_signal_add, SourceFuncs.closure_callback
    """
    #  user_data
    def __call__(
        self,
...
class DestroyNotify(typing.Protocol):
    """
    This callback was used in:
        GLib.atomic_rc_box_release_full, GLib.clear_full, GLib.free_full, GLib.new, GLib.new_from_data, GLib.new_full, GLib.rc_box_release_full, GLib.test_queue_destroy, Private.notify
    """
    #  data
    def __call__(
        self,
...
class Func(typing.Protocol):
    """
    This callback was used in:
        GLib.foreach, GLib.foreach_range, GLib.sequence_foreach_range, ThreadPool.func
    """
    #  data
    def __call__(
        self,
...
class ScannerMsgFunc(typing.Protocol):
    """
    This callback was used in:
        Scanner.msg_handler
    """
...
class prepareSourceFuncsCB(typing.Protocol):
    """
    This callback was used in:
        SourceFuncs.prepare
    """
...
class checkSourceFuncsCB(typing.Protocol):
    """
    This callback was used in:
        SourceFuncs.check
    """
...
class finalizeSourceFuncsCB(typing.Protocol):
    """
    This callback was used in:
...
class SourceDummyMarshal(typing.Protocol):
    """
    This callback was used in:
