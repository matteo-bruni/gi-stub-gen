...
def signal_chain_from_overridden(
    instance_and_params: list[typing.Any],
    return_value: Value,
) -> None:
    """
...
def signal_newv(
    ...
    class_closure: Closure | None,
    accumulator: SignalAccumulator | None,
    *accu_data: object | None,
    c_marshaller: ClosureMarshal | None,
    return_type: GType,
    param_types: list[GType] | None = None,
) -> int:
    """
    ...
    If c_marshaller is None, `g_cclosure_marshal_generic` will be used as
...
class BindingGroup(Object):
    ...
    def __init__(self, source: Object | None = None) -> None:
        """
        Initialize BindingGroup object with properties.
        """
...
class Closure(GBoxed, metaclass=GType):
    ...
    def invalidate(self) -> None:
        ...
        """
    def invoke(self, param_values: list[typing.Any], invocation_hint: object | None = None) -> typing.Any:
        """
...
# Typing-only model of gi._enum.GEnumMeta; not a public PyGObject runtime API.
class _GEnumMeta(enum.EnumType, GType):
    """
    Stub-only static typing model of gi._enum.GEnumMeta. EnumType models the runtime enum behavior; GType models PyGObject's implicit acceptance of enum classes in GType parameters.
    """
    ...
    def __gtype__(self) -> GType:
        """
        The GType associated with the enum class.
        """

# Typing-only model of gi._enum.GFlagsMeta; not a public PyGObject runtime API.
class _GFlagsMeta(enum.EnumType, GType):
    """
    Stub-only static typing model of gi._enum.GFlagsMeta. EnumType models the runtime enum behavior; GType models PyGObject's implicit acceptance of enum classes in GType parameters.
    """
...
class GEnum(enum.IntEnum, metaclass=_GEnumMeta):
    """
...
class InitiallyUnowned(Object):
    ...
    def __init__(self) -> None:
        """
        Initialize InitiallyUnowned object with properties.
        """
...
class InitiallyUnownedClass(GPointer, metaclass=GType):
    ...
    # gi Fields
    @builtins.property
    def construct_properties(self) -> list[object] | None: ...
    @builtins.property
    ...
    def notify(self) -> notifyInitiallyUnownedClassCB:
        ...
        """
    @builtins.property
    def pdummy(self) -> list[object] | None: ...
    @builtins.property
...
class ObjectClass(GPointer, metaclass=GType):
    ...
    def install_property(self, property_id: int, pspec: ParamSpec) -> None:
        ...
        """
    def list_properties(self) -> tuple[list[ParamSpec], int]:
        """
...
class ParamSpecPool(GPointer, metaclass=GType):
    ...
    def insert(self, pspec: ParamSpec, owner_type: GType) -> None:
        ...
        """
    def list(self, owner_type: GType) -> tuple[list[ParamSpec], int]:
        """
            Gets an array of all GParamSpecs owned by `owner_type` in
        the pool.
        """
    def list_owned(self, owner_type: GType) -> list[ParamSpec]:
        """
...
class SignalGroup(Object):
    ...
    # gi Methods
    def __init__(self, target: Object | None = None, target_type: GType | None = None) -> None:
        """
        Initialize SignalGroup object with properties.
        """
    def block(self) -> None:
        """
...
class TypeInterface(GPointer, metaclass=GType):
    ...
    def peek_parent(self) -> TypeInterface:
        ...
        """
    @staticmethod
    def prerequisites(interface_type: GType) -> tuple[list[GType], int]:
        """
        Returns the prerequisites of an interfaces type.
        """
...
class TypeModule(Object):
    ...
    # gi Fields
    @builtins.property
    def interface_infos(self) -> list[object] | None: ...
    @builtins.property
    def name(self) -> str:
        """
    ...
    @builtins.property
    def type_infos(self) -> list[object] | None: ...
    @builtins.property
    ...
    def __init__(self) -> None:
        """
        Initialize TypeModule object with properties.
        """
...
class TypePlugin(builtins.object, metaclass=GType):
    ...
    def __init__(self) -> None:
        """
        Initialize TypePlugin object with properties.
        """
...
class TypeValueTable(GPointer, metaclass=GType):
    ...
    """
    collect_value: TypeValueCollectFunc | None = ...
    """
    ...
    """
    lcopy_value: TypeValueLCopyFunc | None = ...
    """
    ...
    """
    value_peek_pointer: TypeValuePeekPointerFunc | None = ...
    """
...
class Value(GBoxed, metaclass=GType):
    ...
    # gi Fields
    data: list[_Value__data__union] | None = ...
    @builtins.property
    def g_type(self) -> GType: ...
...
class ValueArray(GBoxed, metaclass=GType):
    ...
    # gi Methods
    @deprecated("deprecated")
    def append(self, value: typing.Any = None) -> ValueArray:
        """
    ...
    def get_nth(self, index_: int) -> Value:
        ...
        """
    @deprecated("deprecated")
    def insert(self, index_: int, value: typing.Any = None) -> ValueArray:
        """
            Insert a copy of `value` at specified position into `value_array`. If `value`
        is None, an uninitialized value is inserted.
        """
    @deprecated("deprecated")
    def prepend(self, value: typing.Any = None) -> ValueArray:
        """
...
class InterfaceInitFunc(typing.Protocol):
    """
    This callback was used in:
...
class InterfaceFinalizeFunc(typing.Protocol):
    """
    This callback was used in:
...
class BaseInitFunc(typing.Protocol):
    """
    This callback was used in:
        TypeInfo.base_init
    """
...
class BaseFinalizeFunc(typing.Protocol):
    """
    This callback was used in:
...
class ClassInitFunc(typing.Protocol):
    """
    This callback was used in:
        TypeInfo.class_init
    """
...
class ClassFinalizeFunc(typing.Protocol):
    """
    This callback was used in:
...
class InstanceInitFunc(typing.Protocol):
    """
    This callback was used in:
...
class TypePluginUse(typing.Protocol):
    """
    This callback was used in:
...
class TypePluginUnuse(typing.Protocol):
    """
    This callback was used in:
...
class TypePluginCompleteTypeInfo(typing.Protocol):
    """
    This callback was used in:
...
class TypePluginCompleteInterfaceInfo(typing.Protocol):
    """
    This callback was used in:
...
class TypeValueInitFunc(typing.Protocol):
    """
    This callback was used in:
...
class TypeValueFreeFunc(typing.Protocol):
    """
    This callback was used in:
...
class TypeValueCopyFunc(typing.Protocol):
    """
    This callback was used in:
...
class TypeValuePeekPointerFunc(typing.Protocol):
    """
    This callback was used in:
...
class TypeValueCollectFunc(typing.Protocol):
    """
    This callback was used in:
    ...
    def __call__(
        self,
        value: typing.Any,
        collect_values: list[TypeCValue],
        collect_flags: int,
    ) -> str | None: ...

class TypeValueLCopyFunc(typing.Protocol):
    """
    This callback was used in:
...
class SignalAccumulator(typing.Protocol):
    """
    This callback was used in:
        GObject.signal_newv
    """
...
"""
[DEPRECATED] GObject.OptionContext is deprecated; use GLib.OptionContext instead
"""
OptionGroup = GLib.OptionGroup
"""
[DEPRECATED] GObject.OptionGroup is deprecated; use GLib.OptionGroup instead
"""
PollFD = GLib.PollFD
"""
...
#     - _overrides_module
# type: FunctionInfo, element not parsed are:
