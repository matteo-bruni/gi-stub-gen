...
def signal_query(
    id_or_name: int | str,
    type_: GType | Object | None | None = None,
) -> SignalQuery | None: ...
def type_from_name(
    name: str,
) -> GType: ...
...
class TypeModule(Object):
    ...
    def add_interface(self, instance_type: GType, interface_type: GType, interface_info: InterfaceInfo) -> None:
        ...
        """
    def register_enum(self, name: str, const_static_values: list) -> GType:
        """
        ...
        instead. This can be used when making a static build of the module.
        """
    def register_flags(self, name: str, const_static_values: list) -> GType:
        """
...
class Value(GBoxed, metaclass=GType):
    ...
    def __init__(
        self,
        value_type: GType | None | None = None,
        py_value: typing.Any | None | None = None,
    ) -> None:
        """
