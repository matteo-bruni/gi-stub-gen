...
class Closure(GBoxed):
    ...
    in_marshal: int = ...
    is_invalid: int = ...
    marshal: marshalClosureCB = ...
    meta_marshal_nouse: int = ...
    n_fnotifiers: int = ...
    n_guards: int = ...
    n_inotifiers: int = ...
    notifiers: ClosureNotifyData | None = ...
    ref_count: int = ...
    # gi Methods
    def __init__(self) -> None:
        """
...
class InitiallyUnowned(Object):
    ...
    # gi Fields
    qdata: GLib.Data | None = ...  # type: ignore
    ref_count: int = ...
    # gi Methods
    def __init__(self) -> None:
        """
...
class InitiallyUnownedClass(GPointer):
    ...
    constructed: constructedInitiallyUnownedClassCB = ...
    dispatch_properties_changed: dispatch_properties_changedInitiallyUnownedClassCB = ...
    dispose: disposeInitiallyUnownedClassCB = ...
    finalize: finalizeInitiallyUnownedClassCB = ...
    flags: int = ...
    g_type_class: TypeClass | None = ...
    get_property: get_propertyInitiallyUnownedClassCB = ...
    n_construct_properties: int = ...
    n_pspecs: int = ...
    notify: notifyInitiallyUnownedClassCB = ...
    pdummy: list | None = ...
    set_property: set_propertyInitiallyUnownedClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class ObjectClass(GPointer):
    # gi Fields
    construct_properties: list | None = ...
    constructed: constructedObjectClassCB = ...
    dispatch_properties_changed: dispatch_properties_changedObjectClassCB = ...
    dispose: disposeObjectClassCB = ...
    finalize: finalizeObjectClassCB = ...
    flags: int = ...
    g_type_class: TypeClass | None = ...
    get_property: get_propertyObjectClassCB = ...
    n_construct_properties: int = ...
    n_pspecs: int = ...
    notify: notifyObjectClassCB = ...
    pdummy: list | None = ...
    set_property: set_propertyObjectClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class ParamSpecClass(GPointer):
    # gi Fields
    dummy: list | None = ...
    finalize: finalizeParamSpecClassCB = ...
    g_type_class: TypeClass | None = ...
    value_is_valid: value_is_validParamSpecClassCB = ...
    value_set_default: value_set_defaultParamSpecClassCB = ...
    value_type: GType = ...
    value_validate: value_validateParamSpecClassCB = ...
    values_cmp: values_cmpParamSpecClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class ParamSpecTypeInfo(GPointer):
    # gi Fields
    finalize: finalizeParamSpecTypeInfoCB = ...
    instance_init: instance_initParamSpecTypeInfoCB = ...
    instance_size: int = ...
    n_preallocs: int = ...
    value_set_default: value_set_defaultParamSpecTypeInfoCB = ...
    value_type: GType = ...
    value_validate: value_validateParamSpecTypeInfoCB = ...
    values_cmp: values_cmpParamSpecTypeInfoCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class ParamSpecVariant(ParamSpec):
    ...
    # gi Fields
    default_value: GLib.Variant | None = ...  # type: ignore
    padding: list | None = ...
    type: GLib.VariantType | None = ...  # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class TypeModuleClass(GPointer):
    # gi Fields
    load: loadTypeModuleClassCB = ...
    parent_class: ObjectClass | None = ...
    reserved1: reserved1TypeModuleClassCB = ...
    reserved2: reserved2TypeModuleClassCB = ...
    reserved3: reserved3TypeModuleClassCB = ...
    reserved4: reserved4TypeModuleClassCB = ...
    unload: unloadTypeModuleClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
"""
threads_init = GLib.threads_init  # type: ignore
timeout_add = GLib.timeout_add  # type: ignore
"""
[DEPRECATED] GObject.timeout_add is deprecated; use GLib.timeout_add instead
"""
timeout_add_seconds = GLib.timeout_add_seconds  # type: ignore
"""
...
uri_list_extract_uris = GLib.uri_list_extract_uris  # type: ignore
"""
...
# type: ParamFlags, element not parsed are:
#     - PARAM_CONSTRUCT
...
#     - PARAM_READWRITE
#     - PARAM_WRITABLE
# type: SignalFlags, element not parsed are:
#     - SIGNAL_ACTION
#     - SIGNAL_DETAILED
#     - SIGNAL_NO_HOOKS
#     - SIGNAL_NO_RECURSE
