...
class Application(GObject.Object):
    ...
    def add_option_group(self, group: gi._gi.OptionGroup) -> None: ...
...
class AsyncReadyCallback(typing.Protocol):
    """
    This callback was used in:
                        Gio.new_for_bus, Gio.fill_async, Gio.create_async, Gio.stop, Gio.unmount_mountable_with_operation, Gio.query_default_handler_async, Gio.can_reach_async, Gio.writev_async, Gio.app_info_get_default_for_type_async, Gio.flush, Gio.stop_mountable, Gio.query_info_async, Gio.read_upto_async, Gio.communicate_async, Gio.bus_get, Gio.receive_credentials_async, Gio.handshake_async, Gio.flush_async, Gio.mount_mountable, Gio.connect_to_host_async, Gio.remount, Gio.lookup_service_async, Gio.new_tmp_async, Gio.eject_mountable_with_operation, Gio.poll_for_media, Gio.delete_async, Gio.get_default_for_uri_scheme_async, Gio.load_contents_async, Gio.eject_mountable, Gio.guess_content_type, Gio.connect_to_uri_async, Gio.lookup_certificates_issued_by_async, Gio.lookup_async, Gio.next_async, Gio.ask_password_async, Gio.request_certificate_async, Gio.mount_enclosing_volume, Gio.file_new_tmp_dir_async, Gio.new_for_address, Gio.connect_async, Gio.lookup_by_name_async, Gio.mount, Gio.close_async, Gio.append_to_async, Gio.read_until_async, Gio.unmount, Gio.wait_async, Gio.find_enclosing_mount_async, Gio.verify_chain_async, Gio.create_readwrite_async, Gio.lookup_by_name_with_flags_async, Gio.wait_check_async, Gio.connect_to_service_async, Gio.enumerate_children_async, Gio.write_all_async, Gio.new_from_error, Gio.send_message_with_reply, Gio.call, Gio.launch_default_for_uri_async, Gio.query_filesystem_info_async, Gio.poll_mountable, Gio.write_bytes_async, Gio.file_new_tmp_async, Gio.skip_async, Gio.start, Gio.unmount_mountable, Gio.eject_with_operation, Gio.accept_async, Gio.read_line_async, Gio.make_directory_async, Gio.replace_async, Gio.set_attributes_async, Gio.trash_async, Gio.lookup_by_address_async, Gio.communicate_utf8_async, Gio.app_info_launch_default_for_uri_async, Gio.load_bytes_async, Gio.new_tmp_dir_async, Gio.send_credentials_async, Gio.next_files_async, Gio.unmount_with_operation, Gio.read_bytes_async, Gio.read_async, Gio.call_with_unix_fd_list, Gio.shutdown_async, Gio.write_async, Gio.lookup_certificate_issuer_async, Gio.set_display_name_async, Gio.writev_all_async, Gio.simple_async_report_gerror_in_idle, Gio.newv_async, Gio.replace_contents_async, Gio.replace_contents_bytes_async, Gio.close, Gio.replace_readwrite_async, Gio.new, Gio.read_all_async, Gio.release_async, Gio.accept_socket_async, Gio.lookup_certificate_for_handle_async, Gio.make_symbolic_link_async, Gio.app_info_get_default_for_uri_scheme_async, Gio.acquire_async, Gio.splice_async, Gio.init_async, Gio.dbus_address_get_stream, Gio.report_error, Gio.launch_uris_async, Gio.get_default_for_type_async, Gio.open_readwrite_async, Gio.start_mountable, Gio.eject, Gio.lookup_records_async, Gio.async_initable_newv_async, Gio.load_async
    """
    #  source_object
    def __call__(
        self,
...
class DBusProxyTypeFunc(typing.Protocol):
    """
    This callback was used in:
                        Gio.new_for_bus_sync, Gio.new_sync, Gio.new, Gio.new_for_bus
    """
    #  manager
    def __call__(
        self,
...
class DesktopAppLaunchCallback(typing.Protocol):
    """
    This callback was used in:
                        Gio.launch_uris_as_manager_with_fds, Gio.launch_uris_as_manager
    """
    #  appinfo
    def __call__(
        self,
...
desktop_app_info_lookup_get_default_for_uri_scheme = GioUnix.desktop_app_info_lookup_get_default_for_uri_scheme  # type: ignore
"""
