...
class Colorspace(GObject.GEnum, enum.IntEnum):
    """
...
class InterpType(GObject.GEnum, enum.IntEnum):
    """
...
class PixbufAlphaMode(GObject.GEnum, enum.IntEnum):
    """
...
class PixbufError(GObject.GEnum, enum.IntEnum):
    """
...
class PixbufRotation(GObject.GEnum, enum.IntEnum):
    """
...
class Pixbuf(GObject.Object):
    ...
    **NOTE**: If you are copying raw pixbuf data with ``memcpy`` note that the
    ...
    def saturate_and_pixelate(self, dest: Pixbuf, saturation: float, pixelate: bool) -> None:
        ...
        """
    def save_to_bufferv(
        self, type: str, option_keys: list[str] | None = None, option_values: list[str] | None = None
    ) -> tuple[bool, bytes]:
        """
    ...
    def save_to_streamv_async(
        ...
        *user_data: object | None,
        ...
        """
    def savev(
        self, filename: str, type: str, option_keys: list[str] | None = None, option_values: list[str] | None = None
    ) -> bool:
        """
...
class PixbufAnimation(GObject.Object):
    ...
    def get_iter(self, start_time: GLib.TimeVal | None = None) -> PixbufAnimationIter:
        ...
        If you're using GdkPixbuf.Loader, in addition to updating the image
...
class PixbufAnimationIter(GObject.Object):
    ...
    def on_currently_loading_frame(self) -> bool:
        ...
        GdkPixbuf.Loader when loading an animation.
...
class PixbufLoader(GObject.Object):
    ...
    def get_animation(self) -> PixbufAnimation | None:
        """
            Queries the GdkPixbuf.Animation that a pixbuf loader is currently creating.
...
class PixbufModuleLoadFunc(typing.Protocol):
    """
    This callback was used in:
        PixbufModule.load
    """
...
class PixbufModuleLoadXpmDataFunc(typing.Protocol):
    """
    This callback was used in:
...
class PixbufModuleStopLoadFunc(typing.Protocol):
    """
    This callback was used in:
...
class PixbufModuleIncrementLoadFunc(typing.Protocol):
    """
    This callback was used in:
...
class PixbufModuleLoadAnimationFunc(typing.Protocol):
    """
    This callback was used in:
...
class PixbufModuleSaveFunc(typing.Protocol):
    """
    This callback was used in:
        PixbufModule.save
    """
...
class PixbufModuleSaveOptionSupportedFunc(typing.Protocol):
    """
    This callback was used in:
