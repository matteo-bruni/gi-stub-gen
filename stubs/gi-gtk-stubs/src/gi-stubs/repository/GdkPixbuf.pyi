...
class PixbufAnimationClass(GObject.GPointer):
    # gi Fields
    get_iter: get_iterPixbufAnimationClassCB = ...
    get_size: get_sizePixbufAnimationClassCB = ...
    get_static_image: get_static_imagePixbufAnimationClassCB = ...
    is_static_image: is_static_imagePixbufAnimationClassCB = ...
...
class PixbufAnimationIterClass(GObject.GPointer):
    # gi Fields
    advance: advancePixbufAnimationIterClassCB = ...
    get_delay_time: get_delay_timePixbufAnimationIterClassCB = ...
    get_pixbuf: get_pixbufPixbufAnimationIterClassCB = ...
    on_currently_loading_frame: on_currently_loading_framePixbufAnimationIterClassCB = ...
    parent_class: GObject.ObjectClass | None = ...  # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
...
class PixbufLoaderClass(GObject.GPointer):
    # gi Fields
    area_prepared: area_preparedPixbufLoaderClassCB = ...
    area_updated: area_updatedPixbufLoaderClassCB = ...
    closed: closedPixbufLoaderClassCB = ...
    parent_class: GObject.ObjectClass | None = ...  # type: ignore
    size_prepared: size_preparedPixbufLoaderClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
