...
class Attribute(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Methods
    @staticmethod
    def set_free(attrib_set: list[object]) -> None:
        """
            Frees the memory used by an Atk.AttributeSet, including all its
        Atk.Attributes.
        """
...
class Document(builtins.object, metaclass=GObject.GType):
    ...
    def set_attribute_value(self, attribute_name: str, attribute_value: str) -> bool:
        ...
        """
    def set_text_selections(self, selections: list[TextSelection]) -> bool:
        """
...
class EditableText(builtins.object, metaclass=GObject.GType):
    ...
    def paste_text(self, position: int) -> None:
        ...
        """
    def set_run_attributes(self, attrib_set: list[object], start_offset: int, end_offset: int) -> bool:
        """
...
class MiscClass(GObject.GPointer, metaclass=GObject.GType):
    ...
    def threads_leave(self) -> threads_leaveMiscClassCB:
        ...
        """
    @builtins.property
    def vfuncs(self) -> list[object] | None: ...
...
class Registry(GObject.Object):
    ...
    # gi Fields
    @builtins.property
    def factory_singleton_cache(self) -> dict[object, object] | None: ...
    @builtins.property
    def factory_type_registry(self) -> dict[object, object] | None: ...
    @builtins.property
    def parent(self) -> GObject.Object | None: ...
...
class Relation(GObject.Object):
    ...
    @builtins.property
    def target(self) -> list[object] | None: ...
    ...
    def new(
        ...
        of targets.  See also `Atk.Object.add_relationship`.
        """
...
class RelationSet(GObject.Object):
    ...
    def parent(self) -> GObject.Object | None: ...
    @builtins.property
    def relations(self) -> list[object] | None: ...
...
class StateSet(GObject.Object):
    ...
    def add_state(self, type: StateType) -> bool:
        ...
        """
    def add_states(self, types: list[StateType]) -> None:
        """
    ...
    def contains_state(self, type: StateType) -> bool:
        ...
        """
    def contains_states(self, types: list[StateType]) -> bool:
        """
...
class Text(builtins.object, metaclass=GObject.GType):
    ...
    def add_selection(self, start_offset: int, end_offset: int) -> bool:
        ...
        """
    @staticmethod
    def free_ranges(ranges: list[TextRange]) -> None:
        """
            Frees the memory associated with an array of AtkTextRange. It is assumed
        that the array was returned by the function atk_text_get_bounded_ranges
        and is None terminated.
    ...
    def get_character_extents(self, offset: int, coords: CoordType) -> tuple[int, int, int, int]:
        ...
        """
    def get_default_attributes(self) -> list[object]:
        """
    ...
    def get_range_extents(self, start_offset: int, end_offset: int, coord_type: CoordType) -> TextRectangle:
        ...
        fields are set to -1.
        """
    def get_run_attributes(self, offset: int) -> tuple[list[object], int, int]:
        """
...
class Function(typing.Protocol):
    """
    This callback was used in:
        GObjectAccessibleClass.pad1, GObjectAccessibleClass.pad2, HyperlinkClass.pad1, ObjectClass.pad1, ObjectFactoryClass.pad1, ObjectFactoryClass.pad2, RelationSetClass.pad1, RelationSetClass.pad2, StreamableContentIface.pad1, StreamableContentIface.pad2, StreamableContentIface.pad3
    """
    #  user_data
    def __call__(
        self,
