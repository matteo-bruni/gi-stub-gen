...
class BlendMode(GObject.GEnum, enum.IntEnum):
    """
...
class Corner(GObject.GEnum, enum.IntEnum):
    """
...
class FillRule(GObject.GEnum, enum.IntEnum):
    """
...
class GLUniformType(GObject.GEnum, enum.IntEnum):
    """
...
class LineCap(GObject.GEnum, enum.IntEnum):
    """
...
class LineJoin(GObject.GEnum, enum.IntEnum):
    """
...
class MaskMode(GObject.GEnum, enum.IntEnum):
    """
...
class PathDirection(GObject.GEnum, enum.IntEnum):
    """
...
class PathForeachFlags(GObject.GFlags, enum.IntFlag):
    """
...
class PathOperation(GObject.GEnum, enum.IntEnum):
    """
...
class RenderNodeType(GObject.GEnum, enum.IntEnum):
    """
...
class ScalingFilter(GObject.GEnum, enum.IntEnum):
    """
...
class SerializationError(GObject.GEnum, enum.IntEnum):
    """
...
class TransformCategory(GObject.GEnum, enum.IntEnum):
    """
...
class ConicGradientNode(RenderNode, metaclass=GObject.GType):
    ...
    def get_center(self) -> Graphene.Point:
        ...
        """
    def get_color_stops(self) -> tuple[list[ColorStop], int]:
        """
...
class GLShaderNode(RenderNode, metaclass=GObject.GType):
    ...
    def new(
        ...
        bounds: Graphene.Rect,
        args: GLib.Bytes,
        children: list[RenderNode] | None = None,
    ) -> GLShaderNode:
        """
        [is-override: Note this method is an override in Python of the original gi implementation.]
...
class Renderer(GObject.Object):
    ...
    def get_surface(self) -> Gdk.Surface | None:
        """
            Retrieves the `GdkSurface` set using `Gsk.enderer_realize`.
...
class RoundedRect(GObject.GPointer, metaclass=GObject.GType):
    ...
    """
    corner: list[Graphene.Size] | None = ...
    """
...
class Stroke(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        Frees a `GskStroke`.
        """
    def get_dash(self) -> tuple[list[float] | None, int]:
        """
        Gets the dash array in use or `None` if dashing is disabled.
        """
    ...
    def get_miter_limit(self) -> float:
        ...
        """
    def set_dash(self, dash: list[float] | None = None) -> None:
        """
...
class TextNode(RenderNode, metaclass=GObject.GType):
    ...
    def get_font(self) -> Pango.Font:
        ...
        """
    def get_glyphs(self) -> tuple[list[Pango.GlyphInfo], int]:
        """
...
class Transform(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def to_2d(self) -> tuple[float, float, float, float, float, float]:
        ...
        sure, use `Gsk.Transform.get_category` >=
        Gsk.TRANSFORM_CATEGORY_2D to check.
    ...
    def to_2d_components(self) -> tuple[float, float, float, float, float, float, float]:
        ...
        `self` must be a 2D transformation. If you are not sure, use
            ...
            `Gsk.Transform.get_category` >= Gsk.TRANSFORM_CATEGORY_2D
    ...
    def to_affine(self) -> tuple[float, float, float, float]:
        ...
        by this function, use
            ...
            gsk_transform_scale (gsk_transform_translate (None,
        ...
        sure, use
            ...
            `Gsk.Transform.get_category` >= Gsk.TRANSFORM_CATEGORY_2D_AFFINE
    ...
    def to_translate(self) -> tuple[float, float]:
        ...
        sure, use
            ...
            `Gsk.Transform.get_category` >= Gsk.TRANSFORM_CATEGORY_2D_TRANSLATE
