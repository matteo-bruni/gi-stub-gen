...
class AudioVisualizerClass(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
...
class AudioVisualizerPrivate(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
...
class DiscovererClass(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
    def _reserved(self) -> list | None: ...
    @builtins.property
...
class DiscovererPrivate(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
...
class EncodingAudioProfileClass(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
...
class EncodingContainerProfileClass(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
...
class EncodingProfileClass(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
...
class EncodingVideoProfileClass(GObject.GPointer, metaclass=GObject.GTypeMeta): ...

class InstallPluginsContext(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Methods
