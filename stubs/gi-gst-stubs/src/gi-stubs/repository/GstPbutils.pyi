...
def codec_utils_opus_parse_caps(
    caps: Gst.Caps,
) -> tuple[bool, int | None, int | None, int | None, int | None, int | None, list | None]: ...
def codec_utils_opus_parse_header(
    header: Gst.Buffer,
) -> tuple[bool, int | None, int | None, int | None, int | None, int | None, list | None, int | None, int | None]: ...
...
class AudioVisualizer(Gst.Element):
    ...
    # gi Fields
    ainfo: GstAudio.AudioInfo | None = ...  # type: ignore
    req_spf: int = ...
    vinfo: GstVideo.VideoInfo | None = ...  # type: ignore
    # gi Methods
...
class AudioVisualizerClass(GObject.GPointer):
    # gi Fields
    decide_allocation: decide_allocationAudioVisualizerClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    render: renderAudioVisualizerClassCB = ...
    setup: setupAudioVisualizerClassCB = ...
    # gi Methods
...
class Discoverer(GObject.Object):
    ...
    def connect(
        ...
        handler: typing.Callable[[typing_extensions.Self, DiscovererInfo, None | None], None],
        *args: typing.Any,
    ) -> int: ...
    @typing.overload
    def connect(
...
class DiscovererClass(GObject.GPointer):
    # gi Fields
    discovered: discoveredDiscovererClassCB = ...
    finished: finishedDiscovererClassCB = ...
    load_serialize_info: load_serialize_infoDiscovererClassCB = ...
    parentclass: GObject.ObjectClass | None = ...  # type: ignore
    source_setup: source_setupDiscovererClassCB = ...
    starting: startingDiscovererClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
