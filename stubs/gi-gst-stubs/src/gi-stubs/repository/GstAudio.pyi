...
class AudioAggregator(GstBase.Aggregator):
    ...
    # gi Fields
    current_caps: Gst.Caps | None = ...  # type: ignore
    # gi Methods
    def __init__(
        self,
...
class AudioAggregatorClass(GObject.GPointer):
    # gi Fields
    aggregate_one_buffer: aggregate_one_bufferAudioAggregatorClassCB = ...
    create_output_buffer: create_output_bufferAudioAggregatorClassCB = ...
...
class AudioAggregatorConvertPadClass(GObject.GPointer):
    # gi Fields
    parent_class: AudioAggregatorPadClass | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioAggregatorPad(GstBase.AggregatorPad):
    ...
    info: AudioInfo | None = ...
    # gi Methods
    def __init__(self, qos_messages: bool = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
        """
...
class AudioAggregatorPadClass(GObject.GPointer):
    # gi Fields
    convert_buffer: convert_bufferAudioAggregatorPadClassCB = ...
    parent_class: GstBase.AggregatorPadClass | None = ...  # type: ignore
    update_conversion_info: update_conversion_infoAudioAggregatorPadClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioBaseSink(GstBase.BaseSink):
    ...
    latency_time: int = ...
    next_sample: int = ...
    provided_clock: Gst.Clock | None = ...  # type: ignore
    ringbuffer: AudioRingBuffer | None = ...
    # gi Methods
    def __init__(
        self,
        alignment_threshold: int = ...,
    ...
    def set_custom_slaving_callback(
        self, callback: AudioBaseSinkCustomSlavingCallback, user_data: object | None, notify: GLib.DestroyNotify
    ) -> None: ...
...
class AudioBaseSinkClass(GObject.GPointer):
    # gi Fields
    create_ringbuffer: create_ringbufferAudioBaseSinkClassCB | None = ...
    parent_class: GstBase.BaseSinkClass | None = ...  # type: ignore
    payload: payloadAudioBaseSinkClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioBaseSrc(GstBase.PushSrc):
    ...
    # gi Fields
    buffer_time: int = ...
    clock: Gst.Clock | None = ...  # type: ignore
    element: GstBase.PushSrc | None = ...  # type: ignore
    latency_time: int = ...
    next_sample: int = ...
    ringbuffer: AudioRingBuffer | None = ...
    # gi Methods
...
class AudioBaseSrcClass(GObject.GPointer):
    # gi Fields
    create_ringbuffer: create_ringbufferAudioBaseSrcClassCB | None = ...
    parent_class: GstBase.PushSrcClass | None = ...  # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioBuffer(GObject.GPointer):
    ...
    info: AudioInfo | None = ...
    map_infos: Gst.MapInfo | None = ...  # type: ignore
    n_planes: int = ...
    n_samples: int = ...
    priv_map_infos_arr: list | None = ...
...
class AudioCdSrc(GstBase.PushSrc):
    ...
    # gi Fields
    pushsrc: GstBase.PushSrc | None = ...  # type: ignore
    tags: Gst.TagList | None = ...  # type: ignore
    # gi Methods
    def __init__(self, device: str = ..., mode: AudioCdSrcMode = ..., track: int = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
        """
...
class AudioCdSrcClass(GObject.GPointer):
    # gi Fields
    close: closeAudioCdSrcClassCB = ...
    open: openAudioCdSrcClassCB = ...
    pushsrc_class: GstBase.PushSrcClass | None = ...  # type: ignore
    read_sector: read_sectorAudioCdSrcClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioClock(Gst.SystemClock):
    # gi Fields
    clock: Gst.SystemClock | None = ...  # type: ignore
    destroy_notify: GLib.DestroyNotifyAudioClockCB = ...  # type: ignore
    func: AudioClockGetTimeFuncAudioClockCB = ...
    last_time: int = ...
    time_offset: int = ...
    # gi Methods
    def __init__(self) -> None:
    ...
    @classmethod
    def new(
        cls, name: str, func: AudioClockGetTimeFunc, user_data: object | None, destroy_notify: GLib.DestroyNotify
    ) -> Gst.Clock: ...
...
class AudioClockClass(GObject.GPointer):
    # gi Fields
    parent_class: Gst.SystemClockClass | None = ...  # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioConverter(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    def get_config(self) -> tuple[Gst.Structure, int | None, int | None]: ...
...
class AudioDecoder(Gst.Element):
    ...
    # gi Methods
    def __init__(self, max_errors: int = ..., min_latency: int = ..., plc: bool = ..., tolerance: int = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
        """
...
class AudioDecoderClass(GObject.GPointer):
    # gi Fields
    close: closeAudioDecoderClassCB = ...
    decide_allocation: decide_allocationAudioDecoderClassCB = ...
    element_class: Gst.ElementClass | None = ...  # type: ignore
    flush: flushAudioDecoderClassCB = ...
    getcaps: getcapsAudioDecoderClassCB = ...
    handle_frame: handle_frameAudioDecoderClassCB = ...
    negotiate: negotiateAudioDecoderClassCB = ...
    open: openAudioDecoderClassCB = ...
    parse: parseAudioDecoderClassCB = ...
    pre_push: pre_pushAudioDecoderClassCB = ...
    propose_allocation: propose_allocationAudioDecoderClassCB = ...
    set_format: set_formatAudioDecoderClassCB = ...
    sink_event: sink_eventAudioDecoderClassCB = ...
    sink_query: sink_queryAudioDecoderClassCB = ...
    src_event: src_eventAudioDecoderClassCB = ...
    src_query: src_queryAudioDecoderClassCB = ...
    start: startAudioDecoderClassCB = ...
    stop: stopAudioDecoderClassCB = ...
    transform_meta: transform_metaAudioDecoderClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioEncoder(Gst.Element):
    ...
    stream_lock: GLib.RecMutex | None = ...  # type: ignore
    # gi Methods
    def __init__(self, hard_resync: bool = ..., perfect_timestamp: bool = ..., tolerance: int = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
        """
    def allocate_output_buffer(self, size: int) -> Gst.Buffer: ...
...
class AudioEncoderClass(GObject.GPointer):
    # gi Fields
    close: closeAudioEncoderClassCB = ...
    decide_allocation: decide_allocationAudioEncoderClassCB = ...
    element_class: Gst.ElementClass | None = ...  # type: ignore
    flush: flushAudioEncoderClassCB = ...
    getcaps: getcapsAudioEncoderClassCB = ...
    handle_frame: handle_frameAudioEncoderClassCB = ...
    negotiate: negotiateAudioEncoderClassCB = ...
    open: openAudioEncoderClassCB = ...
    pre_push: pre_pushAudioEncoderClassCB = ...
    propose_allocation: propose_allocationAudioEncoderClassCB = ...
    set_format: set_formatAudioEncoderClassCB = ...
    sink_event: sink_eventAudioEncoderClassCB = ...
    sink_query: sink_queryAudioEncoderClassCB = ...
    src_event: src_eventAudioEncoderClassCB = ...
    src_query: src_queryAudioEncoderClassCB = ...
    start: startAudioEncoderClassCB = ...
    stop: stopAudioEncoderClassCB = ...
    transform_meta: transform_metaAudioEncoderClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioFilter(GstBase.BaseTransform):
    # gi Fields
    basetransform: GstBase.BaseTransform | None = ...  # type: ignore
    info: AudioInfo | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
...
class AudioFilterClass(GObject.GPointer):
    # gi Fields
    basetransformclass: GstBase.BaseTransformClass | None = ...  # type: ignore
    setup: setupAudioFilterClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioRingBuffer(Gst.Object):
    ...
    acquired: bool = ...
    active: bool = ...
    callback: AudioRingBufferCallbackAudioRingBufferCB = ...
    cb_data_notify: GLib.DestroyNotifyAudioRingBufferCB = ...  # type: ignore
    channel_reorder_map: list | None = ...
    cond: GLib.Cond | None = ...  # type: ignore
    empty_seg: int = ...
    flushing: bool = ...
    memory: int = ...
    need_reorder: bool = ...
    object: Gst.Object | None = ...  # type: ignore
    open: bool = ...
    samples_per_seg: int = ...
    segbase: int = ...
    segdone: int = ...
    size: int = ...
    spec: AudioRingBufferSpec | None = ...
    state: int = ...
    timestamps: int = ...
    waiting: int = ...
    # gi Methods
    ...
    def set_callback(
        self, cb: AudioRingBufferCallback | None, user_data: object | None, notify: GLib.DestroyNotify
    ) -> None: ...
...
class AudioRingBufferClass(GObject.GPointer):
    # gi Fields
    acquire: acquireAudioRingBufferClassCB = ...
    activate: activateAudioRingBufferClassCB = ...
    clear_all: clear_allAudioRingBufferClassCB = ...
    close_device: close_deviceAudioRingBufferClassCB = ...
    commit: commitAudioRingBufferClassCB = ...
    delay: delayAudioRingBufferClassCB = ...
    open_device: open_deviceAudioRingBufferClassCB = ...
    parent_class: Gst.ObjectClass | None = ...  # type: ignore
    pause: pauseAudioRingBufferClassCB = ...
    release: releaseAudioRingBufferClassCB = ...
    resume: resumeAudioRingBufferClassCB = ...
    start: startAudioRingBufferClassCB = ...
    stop: stopAudioRingBufferClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioSinkClass(GObject.GPointer):
    # gi Fields
    close: closeAudioSinkClassCB = ...
    delay: delayAudioSinkClassCB = ...
    extension: AudioSinkClassExtension | None = ...
    open: openAudioSinkClassCB = ...
    parent_class: AudioBaseSinkClass | None = ...
    pause: pauseAudioSinkClassCB = ...
    prepare: prepareAudioSinkClassCB = ...
    reset: resetAudioSinkClassCB = ...
    resume: resumeAudioSinkClassCB = ...
    stop: stopAudioSinkClassCB = ...
    unprepare: unprepareAudioSinkClassCB = ...
    write: writeAudioSinkClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioSinkClassExtension(GObject.GPointer):
    # gi Fields
    clear_all: clear_allAudioSinkClassExtensionCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AudioSrcClass(GObject.GPointer):
    # gi Fields
    close: closeAudioSrcClassCB = ...
    delay: delayAudioSrcClassCB = ...
    open: openAudioSrcClassCB = ...
    parent_class: AudioBaseSrcClass | None = ...
    prepare: prepareAudioSrcClassCB = ...
    read: readAudioSrcClassCB = ...
    reset: resetAudioSrcClassCB = ...
    unprepare: unprepareAudioSrcClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
DestroyNotifyAudioClockCB = GLib.DestroyNotifyAudioClockCB  # type: ignore
...
DestroyNotifyAudioRingBufferCB = GLib.DestroyNotifyAudioRingBufferCB  # type: ignore
