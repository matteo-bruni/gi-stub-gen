...
def dsd_convert(
    ...
    input_plane_offsets: list | None,
    output_plane_offsets: list | None,
    num_dsd_bytes: int,
    num_channels: int,
...
class AudioConverter(GObject.GBoxed, metaclass=GObject.GType):
    ...
    # gi Methods
    def convert(self, flags: AudioConverterFlags, in_: bytes, in_size: int) -> tuple[bool, bytes, int]:
        """
...
class AudioFormatInfo(GObject.GPointer, metaclass=GObject.GType):
    ...
    # gi Methods
    def fill_silence(self, dest: bytes, length: int) -> None:
        """
        Fill `length` bytes in `dest` with silence samples for `info`.
        """
...
class AudioRingBuffer(Gst.Object):
    ...
    def close_device(self) -> bool:
        ...
        """
    def commit(self, sample: int, data: bytes, in_samples: int, out_samples: int, accum: int) -> tuple[int, int, int]:
        """
    ...
    def pause(self) -> bool:
        ...
        """
    def prepare_read(self) -> tuple[bool, int, bytes, int]:
        """
            Returns a pointer to memory where the data from segment `segment`
        can be found. This function is mostly used by subclasses.
        """
    def read(self, sample: int, data: bytes, len: int) -> tuple[int, int]:
        """
