...
class AudioBaseSink(GstBase.BaseSink):
    ...
    def set_custom_slaving_callback(self, callback: AudioBaseSinkCustomSlavingCallback, *user_data: object) -> None: ...
...
class AudioClock(Gst.SystemClock):
    ...
    @classmethod
    def new(cls, name: str, func: AudioClockGetTimeFunc, *user_data: object) -> AudioClock: ...
...
class AudioRingBuffer(Gst.Object):
    ...
    def set_callback(self, cb: AudioRingBufferCallback | None = None, *user_data: object) -> None: ...
