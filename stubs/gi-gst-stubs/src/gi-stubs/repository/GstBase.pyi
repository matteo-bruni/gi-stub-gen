...
class BaseParseFrame(GObject.GBoxed, metaclass=GObject.GType):
    ...
    # gi Fields
    @builtins.property
    def _gst_reserved_i(self) -> list[int] | None: ...
    @builtins.property
    def _gst_reserved_p(self) -> list[object] | None: ...
    @builtins.property
...
class ByteWriter(GObject.GPointer, metaclass=GObject.GType):
    ...
    def init(self) -> None:
        ...
        """
    def init_with_data(self, data: bytes, initialized: bool) -> None:
        """
...
class CollectPads(Gst.Object):
    ...
    def _gst_reserved(self) -> list[object] | None: ...
    @builtins.property
    def data(self) -> list[CollectData] | None:
        """
