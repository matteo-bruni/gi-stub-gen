...
class AggregatorClass(GObject.GPointer):
    # gi Fields
    aggregate: aggregateAggregatorClassCB = ...
    clip: clipAggregatorClassCB = ...
    decide_allocation: decide_allocationAggregatorClassCB = ...
    finish_buffer: finish_bufferAggregatorClassCB = ...
    finish_buffer_list: finish_buffer_listAggregatorClassCB = ...
    fixate_src_caps: fixate_src_capsAggregatorClassCB = ...
    flush: flushAggregatorClassCB = ...
    get_next_time: get_next_timeAggregatorClassCB = ...
    negotiate: negotiateAggregatorClassCB = ...
    negotiated_src_caps: negotiated_src_capsAggregatorClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    peek_next_sample: peek_next_sampleAggregatorClassCB | None = ...
    propose_allocation: propose_allocationAggregatorClassCB = ...
    sink_event: sink_eventAggregatorClassCB = ...
    sink_event_pre_queue: sink_event_pre_queueAggregatorClassCB = ...
    sink_query: sink_queryAggregatorClassCB = ...
    sink_query_pre_queue: sink_query_pre_queueAggregatorClassCB = ...
    src_activate: src_activateAggregatorClassCB = ...
    src_event: src_eventAggregatorClassCB = ...
    src_query: src_queryAggregatorClassCB = ...
    start: startAggregatorClassCB = ...
    stop: stopAggregatorClassCB = ...
    update_src_caps: update_src_capsAggregatorClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class AggregatorPadClass(GObject.GPointer):
    # gi Fields
    flush: flushAggregatorPadClassCB = ...
    parent_class: Gst.PadClass | None = ...  # type: ignore
    skip_buffer: skip_bufferAggregatorPadClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class BaseParseClass(GObject.GPointer):
    # gi Fields
    convert: convertBaseParseClassCB = ...
    detect: detectBaseParseClassCB = ...
    get_sink_caps: get_sink_capsBaseParseClassCB = ...
    handle_frame: handle_frameBaseParseClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    pre_push_frame: pre_push_frameBaseParseClassCB = ...
    set_sink_caps: set_sink_capsBaseParseClassCB = ...
    sink_event: sink_eventBaseParseClassCB = ...
    sink_query: sink_queryBaseParseClassCB = ...
    src_event: src_eventBaseParseClassCB = ...
    src_query: src_queryBaseParseClassCB = ...
    start: startBaseParseClassCB = ...
    stop: stopBaseParseClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class BaseSink(Gst.Element):
    ...
    need_preroll: bool = ...
    offset: int = ...
    pad_mode: Gst.PadMode = ...  # type: ignore
    playing_async: bool = ...
    preroll_cond: GLib.Cond | None = ...  # type: ignore
    preroll_lock: GLib.Mutex | None = ...  # type: ignore
    running: bool = ...
    segment: Gst.Segment | None = ...  # type: ignore
    sinkpad: Gst.Pad | None = ...  # type: ignore
    sync: bool = ...
...
class BaseSinkClass(GObject.GPointer):
    # gi Fields
    activate_pull: activate_pullBaseSinkClassCB = ...
    event: eventBaseSinkClassCB = ...
    fixate: fixateBaseSinkClassCB = ...
    get_caps: get_capsBaseSinkClassCB = ...
    get_times: get_timesBaseSinkClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    prepare: prepareBaseSinkClassCB = ...
    prepare_list: prepare_listBaseSinkClassCB = ...
    preroll: prerollBaseSinkClassCB = ...
    propose_allocation: propose_allocationBaseSinkClassCB = ...
    query: queryBaseSinkClassCB = ...
    render: renderBaseSinkClassCB = ...
    render_list: render_listBaseSinkClassCB = ...
    set_caps: set_capsBaseSinkClassCB = ...
    start: startBaseSinkClassCB = ...
    stop: stopBaseSinkClassCB = ...
    unlock: unlockBaseSinkClassCB = ...
    unlock_stop: unlock_stopBaseSinkClassCB = ...
    wait_event: wait_eventBaseSinkClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class BaseSrc(Gst.Element):
    ...
    * #GstBaseSrcClass::do_seek is implemented, performs the seek and returns
    ...
    can_activate_push: bool = ...
    element: Gst.Element | None = ...  # type: ignore
    live_cond: GLib.Cond | None = ...  # type: ignore
    live_lock: GLib.Mutex | None = ...  # type: ignore
    live_running: bool = ...
    need_newsegment: bool = ...
    num_buffers: int = ...
    num_buffers_left: int = ...
    pending_seek: Gst.Event | None = ...  # type: ignore
    random_access: bool = ...
    running: bool = ...
    segment: Gst.Segment | None = ...  # type: ignore
    srcpad: Gst.Pad | None = ...  # type: ignore
...
class BaseSrcClass(GObject.GPointer):
    # gi Fields
    alloc: allocBaseSrcClassCB = ...
    create: createBaseSrcClassCB = ...
    decide_allocation: decide_allocationBaseSrcClassCB = ...
    do_seek: do_seekBaseSrcClassCB = ...
    event: eventBaseSrcClassCB = ...
    fill: fillBaseSrcClassCB = ...
    fixate: fixateBaseSrcClassCB = ...
    get_caps: get_capsBaseSrcClassCB = ...
    get_size: get_sizeBaseSrcClassCB = ...
    get_times: get_timesBaseSrcClassCB = ...
    is_seekable: is_seekableBaseSrcClassCB = ...
    negotiate: negotiateBaseSrcClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    prepare_seek_segment: prepare_seek_segmentBaseSrcClassCB = ...
    query: queryBaseSrcClassCB = ...
    set_caps: set_capsBaseSrcClassCB = ...
    start: startBaseSrcClassCB = ...
    stop: stopBaseSrcClassCB = ...
    unlock: unlockBaseSrcClassCB = ...
    unlock_stop: unlock_stopBaseSrcClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class BaseTransform(Gst.Element):
    ...
    * always_in_place
    ...
    element: Gst.Element | None = ...  # type: ignore
    have_segment: bool = ...
    queued_buf: Gst.Buffer | None = ...  # type: ignore
    segment: Gst.Segment | None = ...  # type: ignore
    sinkpad: Gst.Pad | None = ...  # type: ignore
    srcpad: Gst.Pad | None = ...  # type: ignore
    # gi Methods
...
class BaseTransformClass(GObject.GPointer):
    # gi Fields
    accept_caps: accept_capsBaseTransformClassCB = ...
    before_transform: before_transformBaseTransformClassCB = ...
    copy_metadata: copy_metadataBaseTransformClassCB = ...
    decide_allocation: decide_allocationBaseTransformClassCB = ...
    filter_meta: filter_metaBaseTransformClassCB = ...
    fixate_caps: fixate_capsBaseTransformClassCB = ...
    generate_output: generate_outputBaseTransformClassCB = ...
    get_unit_size: get_unit_sizeBaseTransformClassCB = ...
    parent_class: Gst.ElementClass | None = ...  # type: ignore
    passthrough_on_same_caps: bool = ...
    prepare_output_buffer: prepare_output_bufferBaseTransformClassCB = ...
    propose_allocation: propose_allocationBaseTransformClassCB = ...
    query: queryBaseTransformClassCB = ...
    set_caps: set_capsBaseTransformClassCB = ...
    sink_event: sink_eventBaseTransformClassCB = ...
    src_event: src_eventBaseTransformClassCB = ...
    start: startBaseTransformClassCB = ...
    stop: stopBaseTransformClassCB = ...
    submit_input_buffer: submit_input_bufferBaseTransformClassCB = ...
    transform: transformBaseTransformClassCB = ...
    transform_caps: transform_capsBaseTransformClassCB = ...
    transform_ip: transform_ipBaseTransformClassCB = ...
    transform_ip_on_passthrough: bool = ...
    transform_meta: transform_metaBaseTransformClassCB = ...
    transform_size: transform_sizeBaseTransformClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class DataQueue(GObject.Object):
    ...
    # gi Fields
    object: GObject.Object | None = ...  # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class DataQueueClass(GObject.GPointer):
    # gi Fields
    empty: emptyDataQueueClassCB = ...
    full: fullDataQueueClassCB = ...
...
class PushSrcClass(GObject.GPointer):
    # gi Fields
    alloc: allocPushSrcClassCB = ...
    create: createPushSrcClassCB = ...
    fill: fillPushSrcClassCB = ...
    parent_class: BaseSrcClass | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
...
class TypeFindHelperGetRangeFunction(typing.Protocol):
    """
    This callback was used in:
                        GstBase.type_find_helper_get_range_full, GstBase.type_find_helper_get_range
    """
    #  obj
    def __call__(
        self,
