...
class AppSink(GstBase.BaseSink):
    ...
    # gi Fields
    basesink: GstBase.BaseSink | None = ...  # type: ignore
    # gi Methods
    def __init__(
        self,
        buffer_list: bool = ...,
...
class AppSinkClass(GObject.GPointer):
    # gi Fields
    basesink_class: GstBase.BaseSinkClass | None = ...  # type: ignore
    eos: eosAppSinkClassCB = ...
    new_preroll: new_prerollAppSinkClassCB = ...
    new_sample: new_sampleAppSinkClassCB = ...
    pull_preroll: pull_prerollAppSinkClassCB | None = ...
    pull_sample: pull_sampleAppSinkClassCB | None = ...
    try_pull_object: try_pull_objectAppSinkClassCB | None = ...
    try_pull_preroll: try_pull_prerollAppSinkClassCB | None = ...
    try_pull_sample: try_pull_sampleAppSinkClassCB | None = ...
    # gi Methods
...
class AppSrc(GstBase.BaseSrc):
    ...
    # gi Fields
    basesrc: GstBase.BaseSrc | None = ...  # type: ignore
    # gi Methods
    def __init__(
        self,
        block: bool = ...,
...
class AppSrcClass(GObject.GPointer):
    # gi Fields
    basesrc_class: GstBase.BaseSrcClass | None = ...  # type: ignore
    end_of_stream: end_of_streamAppSrcClassCB = ...
    enough_data: enough_dataAppSrcClassCB = ...
    need_data: need_dataAppSrcClassCB = ...
    push_buffer: push_bufferAppSrcClassCB = ...
    push_buffer_list: push_buffer_listAppSrcClassCB = ...
    push_sample: push_sampleAppSrcClassCB = ...
    seek_data: seek_dataAppSrcClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed.
