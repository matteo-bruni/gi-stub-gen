...
class NetClientClock(Gst.SystemClock):
    ...
    def new(
        ...
        Create a new GstNet.ClientClock that will report the time
        provided by the GstNet.TimeProvider on `remote_address` and
        `remote_port`.
        """
...
class NetTimePacket(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def new(
        ...
        Creates a new GstNet.TimePacket from a buffer received over the network. The
        caller is responsible for ensuring that `buffer` is at least
        GST_NET_TIME_PACKET_SIZE bytes long.

        If `buffer` is None, the local and remote times will be set to
        GST_CLOCK_TIME_NONE.
...
class PtpClock(Gst.SystemClock):
    ...
    def new(
        ...
        GstPtpClock::internal-clock property will become non-None. You can
