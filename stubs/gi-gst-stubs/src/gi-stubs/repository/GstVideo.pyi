...
class VideoScaler(GObject.GPointer, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        """
    def get_coeff(self, out_offset: int) -> tuple[list, int, int]:
        """
...
class VideoVBIEncoder(GObject.GBoxed, metaclass=GObject.GType):
    ...
    # gi Methods
    def add_ancillary(self, composite: bool, DID: int, SDID_block_number: int, data: bytes, data_count: int) -> bool:
        """
