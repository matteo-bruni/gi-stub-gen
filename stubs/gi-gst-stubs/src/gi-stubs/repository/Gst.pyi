...
def tracing_get_active_tracers(
...
class Allocator(Object):
    ...
    # gi Fields
    mem_copy: MemoryCopyFunctionAllocatorCB = ...
    mem_is_span: MemoryIsSpanFunctionAllocatorCB = ...
    mem_map: MemoryMapFunctionAllocatorCB | None = ...
    mem_map_full: MemoryMapFullFunctionAllocatorCB | None = ...
    mem_share: MemoryShareFunctionAllocatorCB = ...
    mem_type: str = ...
    mem_unmap: MemoryUnmapFunctionAllocatorCB = ...
    mem_unmap_full: MemoryUnmapFullFunctionAllocatorCB = ...
    object: Object | None = ...
    # gi Methods
...
class AllocatorClass(GObject.GPointer):
    ...
    # gi Fields
    alloc: allocAllocatorClassCB | None = ...
    free: freeAllocatorClassCB = ...
...
class Bin(Element):
    ...
    * OTHERS: the query is forwarded to all sink elements, the result
    ...
    children_cookie: int = ...
    clock_dirty: bool = ...
    clock_provider: Element | None = ...
    element: Element | None = ...
    messages: list | None = ...
    numchildren: int = ...
    polling: bool = ...
    provided_clock: Clock | None = ...
    state_dirty: bool = ...
    # gi Methods
    ...
    def connect(
        self, 
        detailed_signal: typing.Literal["do-latency"], 
...
class BinClass(GObject.GPointer):
    ...
    # gi Fields
    add_element: add_elementBinClassCB = ...
    deep_element_added: deep_element_addedBinClassCB = ...
    deep_element_removed: deep_element_removedBinClassCB = ...
    do_latency: do_latencyBinClassCB = ...
    element_added: element_addedBinClassCB = ...
    element_removed: element_removedBinClassCB = ...
    handle_message: handle_messageBinClassCB = ...
    parent_class: ElementClass | None = ...
    pool: GLib.ThreadPool | None = ... # type: ignore
    remove_element: remove_elementBinClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Buffer(GObject.GBoxed):
    ...
    def add_reference_timestamp_meta(self, reference: Caps, timestamp: int, duration: int) -> ReferenceTimestampMeta | None: ...
    ...
    def new(cls) -> Buffer: ...
    @classmethod
    def new_allocate(cls, allocator: Allocator | None, size: int, params: AllocationParams | None = None) -> Buffer | None: ...
    @classmethod
    ...
    @classmethod
    def new_wrapped_full(cls, flags: MemoryFlags, data: list, maxsize: int, offset: int, size: int, user_data: object | None = None, notify: GLib.DestroyNotify | None = None) -> Buffer: ...
...
class BufferPool(Object):
    ...
    @staticmethod
    def config_set_allocator(config: Structure, allocator: Allocator | None = None, params: AllocationParams | None = None) -> None: ...
    @staticmethod
...
class BufferPoolClass(GObject.GPointer):
    ...
    # gi Fields
    acquire_buffer: acquire_bufferBufferPoolClassCB = ...
    alloc_buffer: alloc_bufferBufferPoolClassCB = ...
    flush_start: flush_startBufferPoolClassCB = ...
    flush_stop: flush_stopBufferPoolClassCB = ...
    free_buffer: free_bufferBufferPoolClassCB = ...
    get_options: get_optionsBufferPoolClassCB = ...
    object_class: ObjectClass | None = ...
    release_buffer: release_bufferBufferPoolClassCB = ...
    reset_buffer: reset_bufferBufferPoolClassCB = ...
    set_config: set_configBufferPoolClassCB = ...
    start: startBufferPoolClassCB = ...
    stop: stopBufferPoolClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Bus(Object):
    ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_sync_handler(self, func: BusSyncHandler | None, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
class BusClass(GObject.GPointer):
    ...
    # gi Fields
    message: messageBusClassCB = ...
    parent_class: ObjectClass | None = ...
    sync_message: sync_messageBusClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class ByteArrayInterface(GObject.GPointer):
    ...
    data: int = ...
    len: int = ...
    resize: resizeByteArrayInterfaceCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class ChildProxyInterface(GObject.GPointer):
    ...
    # gi Fields
    child_added: child_addedChildProxyInterfaceCB = ...
    child_removed: child_removedChildProxyInterfaceCB = ...
    get_child_by_index: get_child_by_indexChildProxyInterfaceCB | None = ...
    get_child_by_name: get_child_by_nameChildProxyInterfaceCB | None = ...
    get_children_count: get_children_countChildProxyInterfaceCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Clock(Object):
    ...
    def add_observation_unapplied(self, observation_internal: int, observation_external: int) -> tuple[bool, float, int | None, int | None, int | None, int | None]: ...
    ...
    @staticmethod
    def id_wait_async(id: object, func: ClockCallback, user_data: object | None, destroy_data: GLib.DestroyNotify) -> ClockReturn: ...
...
class ClockClass(GObject.GPointer):
    ...
    # gi Fields
    change_resolution: change_resolutionClockClassCB = ...
    get_internal_time: get_internal_timeClockClassCB = ...
    get_resolution: get_resolutionClockClassCB = ...
    parent_class: ObjectClass | None = ...
    unschedule: unscheduleClockClassCB = ...
    wait: waitClockClassCB = ...
    wait_async: wait_asyncClockClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class ClockEntry(GObject.GPointer):
    ...
    # gi Fields
    clock: Clock | None = ...
    destroy_data: GLib.DestroyNotifyClockEntryCB = ... # type: ignore
    func: ClockCallbackClockEntryCB = ...
    interval: int = ...
    refcount: int = ...
    status: ClockReturn = ...
    time: int = ...
...
class ControlBinding(Object):
    ...
    name: str = ...
    object: Object | None = ...
    pspec: GObject.ParamSpec | None = ... # type: ignore
    # gi Methods
...
class ControlBindingClass(GObject.GPointer):
    ...
    # gi Fields
    get_g_value_array: get_g_value_arrayControlBindingClassCB = ...
    get_value: get_valueControlBindingClassCB | None = ...
    parent_class: ObjectClass | None = ...
    sync_values: sync_valuesControlBindingClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class ControlSource(Object):
    ...
    # gi Fields
    get_value: ControlSourceGetValueControlSourceCB = ...
    get_value_array: ControlSourceGetValueArrayControlSourceCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class DateTime(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, tzoffset: float, year: int, month: int, day: int, hour: int, minute: int, seconds: float) -> DateTime | None: ...
    @classmethod
...
class Device(Object):
    ...
    # gi Methods
    def __init__(self, caps: Caps | None = ..., device_class: str = ..., display_name: str = ..., properties: Structure | None = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
        """
    ...
    def connect(
        self, 
        detailed_signal: typing.Literal["removed"], 
...
class DeviceClass(GObject.GPointer):
    ...
    # gi Fields
    create_element: create_elementDeviceClassCB | None = ...
    parent_class: ObjectClass | None = ...
    reconfigure_element: reconfigure_elementDeviceClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class DeviceProviderClass(GObject.GPointer):
    ...
    # gi Fields
    factory: DeviceProviderFactory | None = ...
    parent_class: ObjectClass | None = ...
    start: startDeviceProviderClassCB = ...
    stop: stopDeviceProviderClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Element(Object):
    ...
    srcpads: list | None = ...
    start_time: int = ...
    state_cond: GLib.Cond | None = ... # type: ignore
    state_cookie: int = ...
    state_lock: GLib.RecMutex | None = ... # type: ignore
    target_state: State = ...
    # gi Methods
    def __init__(self) -> None:
        """
    ...
    def call_async(self, func: ElementCallAsyncFunc, user_data: object | None, destroy_notify: GLib.DestroyNotify) -> None: ...
    ...
    def link_pads_filtered(self, srcpadname: str | None, dest: Element, destpadname: str | None = None, filter: Caps | None = None) -> bool: ...
    def link_pads_full(self, srcpadname: str | None, dest: Element, destpadname: str | None, flags: PadLinkCheck) -> bool: ...
    def lost_state(self) -> None: ...
    @staticmethod
    def make_from_uri(type: URIType, uri: str, elementname: str | None = None) -> Element: ...
    def message_full(self, type: MessageType, domain: int, code: int, text: str | None, debug: str | None, file: str, function: str, line: int) -> None: ...
    def message_full_with_details(self, type: MessageType, domain: int, code: int, text: str | None, debug: str | None, file: str, function: str, line: int, structure: Structure) -> None: ...
    ...
    def connect(
        self, 
        detailed_signal: typing.Literal["no-more-pads"], 
        handler: typing.Callable[..., None], 
        *args: typing.Any
    ) -> int: ...
    @typing.overload
...
class ElementClass(GObject.GPointer):
    ...
    # gi Fields
    change_state: change_stateElementClassCB = ...
    elementfactory: ElementFactory | None = ...
    get_state: get_stateElementClassCB = ...
    no_more_pads: no_more_padsElementClassCB = ...
    numpadtemplates: int = ...
    pad_added: pad_addedElementClassCB = ...
    pad_removed: pad_removedElementClassCB = ...
    pad_templ_cookie: int = ...
    padtemplates: list | None = ...
    parent_class: ObjectClass | None = ...
    post_message: post_messageElementClassCB = ...
    provide_clock: provide_clockElementClassCB | None = ...
    query: queryElementClassCB = ...
    release_pad: release_padElementClassCB = ...
    request_new_pad: request_new_padElementClassCB | None = ...
    send_event: send_eventElementClassCB = ...
    set_bus: set_busElementClassCB = ...
    set_clock: set_clockElementClassCB = ...
    set_context: set_contextElementClassCB = ...
    set_state: set_stateElementClassCB = ...
    state_changed: state_changedElementClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class ElementFactory(PluginFeature):
    ...
    @staticmethod
    def make_with_properties(factoryname: str, n: int, names: list | None = None, values: list | None = None) -> Element | None: ...
...
class Event(GObject.GBoxed):
    ...
    def parse_seek(self) -> tuple[float | None, Format | None, SeekFlags | None, SeekType | None, int | None, SeekType | None, int | None]: ...
...
class GhostPadClass(GObject.GPointer):
    ...
    # gi Fields
    parent_class: ProxyPadClass | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Memory(GObject.GBoxed):
    ...
    def map(self, flags: MapFlags) -> tuple[bool, MapInfo]: ...
    @classmethod
    def new_wrapped(cls, flags: MemoryFlags, data: list, maxsize: int, offset: int, size: int, user_data: object | None = None, notify: GLib.DestroyNotify | None = None) -> Memory | None: ...
    def resize(self, offset: int, size: int) -> None: ...
...
class Message(GObject.GBoxed):
    ...
    # gi Fields
    cond: GLib.Cond | None = ... # type: ignore
    lock: GLib.Mutex | None = ... # type: ignore
    mini_object: MiniObject | None = ...
    seqnum: int = ...
    src: Object | None = ...
    ...
    def __init__(self) -> None:
        ...
        Generated __init__ stub method. order not guaranteed. 
        """
    def add_redirect_entry(self, location: str, tag_list: TagList | None = None, entry_struct: Structure | None = None) -> None: ...
    ...
    @classmethod
    def new_error_with_details(cls, src: Object | None, error: None, debug: str, details: Structure | None = None) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_info_with_details(cls, src: Object | None, error: None, debug: str, details: Structure | None = None) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_qos(cls, src: Object | None, live: bool, running_time: int, stream_time: int, timestamp: int, duration: int) -> Message: ...
    @classmethod
    def new_redirect(cls, src: Object | None, location: str, tag_list: TagList | None = None, entry_struct: Structure | None = None) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_step_done(cls, src: Object | None, format: Format, amount: int, rate: float, flush: bool, intermediate: bool, duration: int, eos: bool) -> Message: ...
    @classmethod
    def new_step_start(cls, src: Object | None, active: bool, format: Format, amount: int, rate: float, flush: bool, intermediate: bool) -> Message: ...
    @classmethod
    ...
    @classmethod
    def new_warning_with_details(cls, src: Object | None, error: None, debug: str, details: Structure | None = None) -> Message: ...
    ...
    def parse_step_done(self) -> tuple[Format | None, int | None, float | None, bool | None, bool | None, int | None, bool | None]: ...
    def parse_step_start(self) -> tuple[bool | None, Format | None, int | None, float | None, bool | None, bool | None]: ...
    def parse_stream_collection(self) -> StreamCollection | None: ...
...
class Meta(GObject.GPointer):
    ...
    def __init__(self) -> None:
        ...
        """
    @staticmethod
    def api_type_aggregate_params(api: GObject.GType, aggregated_params: Structure, params0: Structure, params1: Structure) -> bool: ...
    @staticmethod
    ...
    def get_seqnum(self) -> int: ...
    @staticmethod
    def register_custom(name: str, tags: list, transform_func: CustomMetaTransformFunction | None, user_data: object | None, destroy_data: GLib.DestroyNotify) -> MetaInfo: ...
    @staticmethod
...
class Object(GObject.InitiallyUnowned):
    ...
    lock: GLib.Mutex | None = ... # type: ignore
    name: str = ...
    object: GObject.InitiallyUnowned | None = ... # type: ignore
    # gi Methods
    ...
    @staticmethod
    def default_deep_notify(object: GObject.Object, orig: Object, pspec: GObject.ParamSpec, excluded_props: list | None = None) -> None: ...
...
class ObjectClass(GObject.GPointer):
    ...
    # gi Fields
    deep_notify: deep_notifyObjectClassCB = ...
    parent_class: GObject.InitiallyUnownedClass | None = ... # type: ignore
...
class Pad(Object):
    ...
    # gi Fields
    activatefunc: PadActivateFunctionPadCB = ...
    activatemodefunc: PadActivateModeFunctionPadCB = ...
    activatemodenotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    activatenotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    block_cond: GLib.Cond | None = ... # type: ignore
    chainfunc: PadChainFunctionPadCB = ...
    chainlistfunc: PadChainListFunctionPadCB = ...
    chainlistnotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    chainnotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    direction: PadDirection = ...
    eventfunc: PadEventFunctionPadCB = ...
    eventnotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    getrangefunc: PadGetRangeFunctionPadCB = ...
    getrangenotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    iterintlinkfunc: PadIterIntLinkFunctionPadCB = ...
    iterintlinknotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    linkfunc: PadLinkFunctionPadCB = ...
    linknotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    mode: PadMode = ...
    num_blocked: int = ...
    num_probes: int = ...
    object: Object | None = ...
    offset: int = ...
    padtemplate: PadTemplate | None = ...
    peer: Pad | None = ...
    probes: GLib.HookList | None = ... # type: ignore
    queryfunc: PadQueryFunctionPadCB = ...
    querynotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    stream_rec_lock: GLib.RecMutex | None = ... # type: ignore
    task: Task | None = ...
    unlinkfunc: PadUnlinkFunctionPadCB = ...
    unlinknotify: GLib.DestroyNotifyPadCB = ... # type: ignore
    # gi Methods
    ...
    def add_probe(self, mask: PadProbeType, callback: PadProbeCallback, user_data: object | None, destroy_data: GLib.DestroyNotify) -> int: ...
    ...
    def send_event(self, event: Event) -> bool: ...
    def set_activate_function_full(self, activate: PadActivateFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_activatemode_function_full(self, activatemode: PadActivateModeFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_active(self, active: bool) -> bool: ...
    def set_chain_function_full(self, chain: PadChainFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_chain_list_function_full(self, chainlist: PadChainListFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_element_private(self, priv: object | None = None) -> None: ...
    def set_event_full_function_full(self, event: PadEventFullFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_event_function_full(self, event: PadEventFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_getrange_function_full(self, get: PadGetRangeFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_iterate_internal_links_function_full(self, iterintlink: PadIterIntLinkFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_link_function_full(self, link: PadLinkFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_offset(self, offset: int) -> None: ...
    def set_query_function_full(self, query: PadQueryFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_unlink_function_full(self, unlink: PadUnlinkFunction, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def start_task(self, func: TaskFunction, user_data: object | None, notify: GLib.DestroyNotify) -> bool: ...
    def sticky_events_foreach(self, foreach_func: PadStickyEventsForeachFunction, user_data: object | None = None) -> None: ...
...
class PadClass(GObject.GPointer):
    ...
    # gi Fields
    linked: linkedPadClassCB = ...
    parent_class: ObjectClass | None = ...
    unlinked: unlinkedPadClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class PadTemplate(Object):
    ...
    presence: PadPresence = ...
    # gi Methods
    def __init__(self, caps: Caps | None = ..., direction: PadDirection = ..., gtype: GObject.GType = ..., name_template: str = ..., presence: PadPresence = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
        """
    @property
    ...
    @classmethod
    def new_from_static_pad_template_with_gtype(cls, pad_template: StaticPadTemplate, pad_type: GObject.GType) -> PadTemplate | None: ...
    @classmethod
    def new_with_gtype(cls, name_template: str, direction: PadDirection, presence: PadPresence, caps: Caps, pad_type: GObject.GType) -> PadTemplate | None: ...
...
class PadTemplateClass(GObject.GPointer):
    ...
    # gi Fields
    pad_created: pad_createdPadTemplateClassCB = ...
    parent_class: ObjectClass | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
...
class Plugin(Object):
    ...
    def __init__(self) -> None:
        ...
        Generated __init__ stub method. order not guaranteed. 
        """
    def add_dependency(self, env_vars: list | None, paths: list | None, names: list | None, flags: PluginDependencyFlags) -> None: ...
    def add_dependency_simple(self, env_vars: str | None, paths: str | None, names: str | None, flags: PluginDependencyFlags) -> None: ...
    ...
    @staticmethod
    def register_static_full(major_version: int, minor_version: int, name: str, description: str, init_full_func: PluginInitFullFunc, version: str, license: str, source: str, package: str, origin: str, user_data: object | None = None) -> bool: ...
...
class PresetInterface(GObject.GPointer):
    ...
    # gi Fields
    delete_preset: delete_presetPresetInterfaceCB = ...
    get_meta: get_metaPresetInterfaceCB = ...
    get_preset_names: get_preset_namesPresetInterfaceCB = ...
    get_property_names: get_property_namesPresetInterfaceCB = ...
    load_preset: load_presetPresetInterfaceCB = ...
    rename_preset: rename_presetPresetInterfaceCB = ...
    save_preset: save_presetPresetInterfaceCB = ...
    set_meta: set_metaPresetInterfaceCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Promise(GObject.GBoxed):
    ...
    def new(cls) -> Promise: ...
    @classmethod
    def new_with_change_func(cls, func: PromiseChangeFunc, user_data: object | None, notify: GLib.DestroyNotify) -> Promise: ...
...
class Query(GObject.GBoxed):
    ...
    def set_nth_allocation_param(self, index: int, allocator: Allocator | None = None, params: AllocationParams | None = None) -> None: ...
...
class Sample(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, buffer: Buffer | None = None, caps: Caps | None = None, segment: Segment | None = None, info: Structure | None = None) -> Sample: ...
...
class Segment(GObject.GBoxed):
    ...
    def do_seek(self, rate: float, format: Format, flags: SeekFlags, start_type: SeekType, start: int, stop_type: SeekType, stop: int) -> tuple[bool, bool | None]: ...
    def free(self) -> None: ...
...
class SharedTaskPoolClass(GObject.GPointer):
    ...
    # gi Fields
    parent_class: TaskPoolClass | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Stream(Object):
    ...
    stream_id: str = ...
    # gi Methods
    def __init__(self, caps: Caps | None = ..., stream_flags: StreamFlags = ..., stream_id: str = ..., stream_type: StreamType = ..., tags: TagList | None = ...) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
        """
    @property
...
class StreamCollectionClass(GObject.GPointer):
    ...
    # gi Fields
    parent_class: ObjectClass | None = ...
    stream_notify: stream_notifyStreamCollectionClassCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Structure(GObject.GBoxed):
    ...
    def filter_and_map_in_place_id_str(self, func: StructureFilterMapIdStrFunc, user_data: object | None = None) -> None: ...
...
class Task(Object):
    ...
    # gi Fields
    cond: GLib.Cond | None = ... # type: ignore
    func: TaskFunctionTaskCB = ...
    lock: GLib.RecMutex | None = ... # type: ignore
    notify: GLib.DestroyNotifyTaskCB = ... # type: ignore
    object: Object | None = ...
    running: bool = ...
    state: TaskState = ...
    thread: GLib.Thread | None = ... # type: ignore
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
    ...
    def set_enter_callback(self, enter_func: TaskThreadFunc, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
    def set_leave_callback(self, leave_func: TaskThreadFunc, user_data: object | None, notify: GLib.DestroyNotify) -> None: ...
...
class TaskPoolClass(GObject.GPointer):
    ...
    # gi Fields
    cleanup: cleanupTaskPoolClassCB = ...
    dispose_handle: dispose_handleTaskPoolClassCB = ...
    join: joinTaskPoolClassCB = ...
    parent_class: ObjectClass | None = ...
    prepare: prepareTaskPoolClassCB = ...
    push: pushTaskPoolClassCB | None = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class TypeFind(GObject.GPointer):
    ...
    @staticmethod
    def register(plugin: Plugin | None, name: str, rank: int, func: TypeFindFunction, extensions: str | None, possible_caps: Caps | None, data: object | None, data_notify: GLib.DestroyNotify) -> bool: ...
...
class URIHandlerInterface(GObject.GPointer):
    ...
    # gi Fields
    get_protocols: get_protocolsURIHandlerInterfaceCB = ...
    get_type: get_typeURIHandlerInterfaceCB = ...
    get_uri: get_uriURIHandlerInterfaceCB | None = ...
    set_uri: set_uriURIHandlerInterfaceCB = ...
    # gi Methods
    def __init__(self) -> None:
        """
        Generated __init__ stub method. order not guaranteed. 
...
class Uri(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, scheme: str | None, userinfo: str | None, host: str | None, port: int, path: str | None = None, query: str | None = None, fragment: str | None = None) -> Uri: ...
    def new_with_base(self, scheme: str | None, userinfo: str | None, host: str | None, port: int, path: str | None = None, query: str | None = None, fragment: str | None = None) -> Uri: ...
...
DestroyNotifyClockEntryCB = GLib.DestroyNotifyClockEntryCB # type: ignore
...
DestroyNotifyPadCB = GLib.DestroyNotifyPadCB # type: ignore
...
DestroyNotifyTaskCB = GLib.DestroyNotifyTaskCB # type: ignore
...
EVENT_NUM_SHIFT: int = ...
EVENT_TYPE_BOTH = EventTypeFlags.None 
"""
...
LICENSE_UNKNOWN: str = ...
LOCK_FLAG_READWRITE = LockFlags.None 
"""
GstLockFlags value alias for GST_LOCK_FLAG_READ | GST_LOCK_FLAG_WRITE 
"""
MAP_READWRITE = MapFlags.None 
"""
...
QUERY_NUM_SHIFT: int = ...
QUERY_TYPE_BOTH = QueryTypeFlags.None 
"""
