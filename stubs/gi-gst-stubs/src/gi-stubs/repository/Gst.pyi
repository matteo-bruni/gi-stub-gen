...
class BusSyncReply(GObject.GEnum):
    ...
    drop the message
    """
    PASS_ = 1  # real value: (pass) changed due to name being a python keyword
    ASYNC_ = 2  # real value: (async) changed due to name being a python keyword
...
class PadProbeReturn(GObject.GEnum):
    ...
    """
    PASS_ = 3  # real value: (pass) changed due to name being a python keyword
    HANDLED = 4
    """
...
class ProgressType(GObject.GEnum):
    ...
    A new task started.
    """
    CONTINUE_ = 1  # real value: (continue) changed due to name being a python keyword
    COMPLETE = 2
    """
    A task completed.
    """
...
class TagScope(GObject.GEnum):
    ...
    """
    GLOBAL_ = 1  # real value: (global) changed due to name being a python keyword
...
class ElementForeachPadFunc(typing.Protocol):
    """
    This callback was used in:
                        Gst.foreach_sink_pad, Gst.foreach_pad, Gst.foreach_src_pad
    """
    #  element
    def __call__(
        self,
...
class AllocationMetaParamsAggregator(typing.Protocol):
    """
    This callback was used in:
                        Gst.meta_api_type_set_params_aggregator, Gst.api_type_set_params_aggregator
    """
    #  aggregated_params
    def __call__(
        self,
...
class CustomMetaTransformFunction(typing.Protocol):
    """
    This callback was used in:
                        Gst.register_custom, Gst.meta_register_custom
    """
    #  transbuf
    def __call__(
        self,
...
class LogFunction(typing.Protocol):
    """
    This callback was used in:
                        Gst.debug_remove_log_function, Gst.debug_add_log_function
    """
    #  category
    def __call__(
        self,
