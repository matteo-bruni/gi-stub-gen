...
class ElementFactory(PluginFeature):
    ...
    def create_with_properties(
        self, names: list[str] | None = None, values: list[GObject.Value] | None = None
    ) -> Element | None:
        """
            Create a new element of the type defined by the given elementfactory.
    ...
    def make_with_properties(
        factoryname: str, names: list[str] | None = None, values: list[GObject.Value] | None = None
    ) -> Element | None:
        """
            Create a new element of the type defined by the given elementfactory.
        The supplied list of properties, will be passed at object construction.
...
class Iterator[T](GObject.GBoxed, metaclass=GObject.GType):
    ...
    def copy(self) -> Iterator[T]:
        ...
        """
    def filter(self, func: GLib.CompareFunc, user_data: GObject.Value) -> Iterator[T]:
        """
...
class ValueList(builtins.object, metaclass=GObject.GType):
    ...
    def append_and_take_value(value: GObject.Value, append_value: GObject.Value) -> None:
        ...
        """
    @staticmethod
    def concat(value1: GObject.Value, value2: GObject.Value) -> typing.Any:
        """
    ...
    def init(value: GObject.Value, prealloc: int) -> GObject.Value:
        ...
        """
    @staticmethod
    def merge(value1: GObject.Value, value2: GObject.Value) -> typing.Any:
        """
