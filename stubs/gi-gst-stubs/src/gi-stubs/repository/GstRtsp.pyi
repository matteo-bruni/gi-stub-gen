...
class RTSPAuthCredential(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    authorization: str = ...
    params: RTSPAuthParam | None = ...
    scheme: RTSPAuthMethod = ...

class RTSPAuthParam(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    name: str = ...
    value: str = ...
...
class RTSPConnection(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Methods
    @staticmethod
    def accept(
    ...
    def set_accept_certificate_func(
        self, func: RTSPConnectionAcceptCertificateFunc, *user_data: object | None
    ) -> None: ...
...
class RTSPExtension(builtins.object, metaclass=GObject.GTypeMeta):
    # gi Methods
...
class RTSPExtensionInterface(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
...
class RTSPMessage(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
    def _gst_reserved(self) -> list | None: ...
    @builtins.property
...
class RTSPRange(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    max: int = ...
    min: int = ...
...
class RTSPTime(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    seconds: float = ...
    type: RTSPTimeType = ...

class RTSPTime2(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    day: int = ...
    frames: float = ...
    month: int = ...
...
class RTSPTimeRange(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    max: RTSPTime | None = ...
    max2: RTSPTime2 | None = ...
    min: RTSPTime | None = ...
...
class RTSPTransport(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
    def _gst_reserved(self) -> list | None: ...
    append: bool = ...
...
class RTSPUrl(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    abspath: str = ...
    family: RTSPFamily = ...
    host: str = ...
...
class RTSPWatch(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Methods
    ...
    def write_data(self, data: list, size: int) -> tuple[RTSPResult, int]: ...

class RTSPWatchFuncs(GObject.GPointer, metaclass=GObject.GTypeMeta):
    # gi Fields
    @builtins.property
    def _gst_reserved(self) -> list | None: ...
    @builtins.property
