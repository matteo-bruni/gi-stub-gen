...
class RTSPConnection(GObject.GPointer, metaclass=GObject.GType):
    ...
    def poll_usec(self, events: RTSPEvent, timeout: int) -> tuple[RTSPResult, RTSPEvent]:
        ...
        """
    @deprecated("deprecated")
    def read(self, data: bytes, timeout: GLib.TimeVal) -> RTSPResult:
        """
        ...
        This function can be cancelled with `gst_rtsp_connection_flush`.
        """
    def read_usec(self, data: bytes, timeout: int) -> RTSPResult:
        """
            Attempt to read `size` bytes into `data` from the connected `conn`, blocking up to
    ...
    def send(self, message: RTSPMessage, timeout: GLib.TimeVal) -> RTSPResult:
        ...
        """
    @deprecated("deprecated")
    def send_messages(self, messages: list[RTSPMessage], timeout: GLib.TimeVal) -> RTSPResult:
        """
        ...
        This function can be cancelled with `gst_rtsp_connection_flush`.
        """
    def send_messages_usec(self, messages: list[RTSPMessage], timeout: int) -> RTSPResult:
        """
            Attempt to send `messages` to the connected `conn`, blocking up to
        the specified `timeout`. `timeout` can be 0, in which case this function
        might block forever.
    ...
    def set_tunneled(self, tunneled: bool) -> None:
        ...
        """
    @deprecated("deprecated")
    def write(self, data: bytes, timeout: GLib.TimeVal) -> RTSPResult:
        """
        ...
        This function can be cancelled with `gst_rtsp_connection_flush`.
        """
    def write_usec(self, data: bytes, timeout: int) -> RTSPResult:
        """
            Attempt to write `size` bytes of `data` to the connected `conn`, blocking up to
        the specified `timeout`. `timeout` can be 0, in which case this function
        might block forever.
...
class RTSPMessage(GObject.GBoxed, metaclass=GObject.GType):
    ...
    @builtins.property
    def hdr_fields(self) -> list[object] | None: ...
    type: RTSPMsgType = ...
    """
    the message type
    """
    ...
    def init_response(
        ...
        response message.
        """
    def parse_auth_credentials(self, field: RTSPHeaderField) -> list[RTSPAuthCredential]:
        """
    ...
    def remove_header_by_name(self, header: str, index: int) -> RTSPResult:
        ...
        """
    def set_body(self, data: bytes) -> RTSPResult:
        """
    ...
    def steal_body_buffer(self) -> tuple[RTSPResult, Gst.Buffer]:
        ...
        calling `gst_rtsp_message_has_body_buffer`.
        """
    def take_body(self, data: bytes) -> RTSPResult:
        """
...
class RTSPWatch(GObject.GPointer, metaclass=GObject.GType):
    ...
    def send_message(self, message: RTSPMessage) -> tuple[RTSPResult, int]:
        ...
        callback.
        """
    def send_messages(self, messages: list[RTSPMessage]) -> tuple[RTSPResult, int]:
        """
    ...
    def wait_backlog_usec(self, timeout: int) -> RTSPResult:
        ...
        free space in the backlog queue and try again.
        """
    def write_data(self, data: bytes) -> tuple[RTSPResult, int]:
        """
