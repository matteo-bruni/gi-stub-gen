...
class Device(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...
class FontFace(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...
class FontOptions(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...

class Glyph(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    index: int = ...
    x: float = ...
    y: float = ...

class Matrix(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
class Path(GObject.GPointer, metaclass=GObject.GTypeMeta): ...
class Pattern(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...
...
class RectangleInt(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    height: int = ...
    width: int = ...
    x: int = ...
...
class Region(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...
class ScaledFont(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...
class Surface(GObject.GBoxed, metaclass=GObject.GTypeMeta): ...

class TextCluster(GObject.GBoxed, metaclass=GObject.GTypeMeta):
    # gi Fields
    num_bytes: int = ...
    num_glyphs: int = ...
