...
def aat_layout_feature_type_get_selector_infos(
    ...
    feature_type: aat_layout_feature_type_t,
    start_offset: int,
) -> tuple[int, list[aat_layout_feature_selector_info_t], int]:
    """
...
def aat_layout_get_feature_types(
    face: face_t,
    start_offset: int,
) -> tuple[int, list[aat_layout_feature_type_t]]:
    """
...
def buffer_get_glyph_positions(
    buffer: buffer_t,
) -> tuple[list[glyph_position_t], int]:
    """
...
def ot_color_glyph_get_layers(
    ...
    glyph: int,
    start_offset: int,
) -> tuple[int, list[ot_color_layer_t] | None]:
    """
...
def ot_math_get_glyph_assembly(
    ...
    direction: direction_t,
    start_offset: int,
) -> tuple[int, list[ot_math_glyph_part_t], int]:
    """
...
def ot_math_get_glyph_kernings(
    ...
    kern: ot_math_kern_t,
    start_offset: int,
) -> tuple[int, list[ot_math_kern_entry_t]]:
    """
...
def ot_math_get_glyph_variants(
    ...
    direction: direction_t,
    start_offset: int,
) -> tuple[int, list[ot_math_glyph_variant_t]]:
    """
...
def ot_name_list_names(
    face: face_t,
) -> tuple[list[ot_name_entry_t], int]:
    """
...
def ot_var_get_axis_infos(
    face: face_t,
    start_offset: int,
) -> tuple[int, list[ot_var_axis_info_t]]:
    """
    Fetches a list of all variation axes in the specified face. The list returned will begin
    at the offset provided.
    """
...
def shape(
    font: font_t,
    buffer: buffer_t,
    features: list[feature_t] | None = None,
) -> None:
    """
...
def shape_full(
    ...
    buffer: buffer_t,
    features: list[feature_t] | None = None,
    shaper_list: list[str] | None = None,
) -> int:
    """
...
def shape_justify(
    font: font_t,
    buffer: buffer_t,
    features: list[feature_t] | None,
    shaper_list: list[str] | None,
    min_target_advance: float,
    max_target_advance: float,
    advance: float,
) -> tuple[int, float, int, float]:
    """
    See `hb_shape_full` for basic details. If `shaper_list` is not `None`, the specified
    shapers will be used in the given order, otherwise the default shapers list
    will be used.
...
def shape_plan_create(
    face: face_t,
    props: segment_properties_t,
    user_features: list[feature_t],
    shaper_list: list[str],
) -> shape_plan_t:
    """
...
class aat_layout_feature_selector_t(GObject.GEnum, enum.IntEnum):
    """
...
class aat_layout_feature_type_t(GObject.GEnum, enum.IntEnum):
    """
...
class buffer_cluster_level_t(GObject.GEnum, enum.IntEnum):
    """
...
class buffer_content_type_t(GObject.GEnum, enum.IntEnum):
    """
...
class buffer_diff_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class buffer_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class buffer_serialize_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class buffer_serialize_format_t(GObject.GEnum, enum.IntEnum):
    """
...
class direction_t(GObject.GEnum, enum.IntEnum):
    """
...
class glyph_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class memory_mode_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_color_palette_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class ot_layout_baseline_tag_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_layout_glyph_class_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_math_constant_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_math_glyph_part_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class ot_math_kern_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_meta_tag_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_metrics_tag_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_name_id_predefined_t(GObject.GEnum, enum.IntEnum):
    """
...
class ot_var_axis_flags_t(GObject.GFlags, enum.IntFlag):
    """
...
class paint_composite_mode_t(GObject.GEnum, enum.IntEnum):
    """
...
class paint_extend_t(GObject.GEnum, enum.IntEnum):
    """
...
class script_t(GObject.GEnum, enum.IntEnum):
    """
...
class style_tag_t(GObject.GEnum, enum.IntEnum):
    """
...
class unicode_combining_class_t(GObject.GEnum, enum.IntEnum):
    """
...
class unicode_general_category_t(GObject.GEnum, enum.IntEnum):
    """
...
class color_line_get_color_stops_func_t(typing.Protocol):
    """
    This callback was used in:
...
class color_line_get_extend_func_t(typing.Protocol):
    """
    This callback was used in:
