...
class GlyphItem(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        """
    def get_logical_widths(self, text: str, logical_widths: list) -> None:
        """
...
class GlyphString(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        """
    def get_logical_widths(self, text: str, length: int, embedding_level: int, logical_widths: list) -> None:
        """
