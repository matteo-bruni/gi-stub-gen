...
class Alignment(GObject.GEnum, enum.IntEnum):
    """
...
class AttrType(GObject.GEnum, enum.IntEnum):
    """
...
class BaselineShift(GObject.GEnum, enum.IntEnum):
    """
...
class BidiType(GObject.GEnum, enum.IntEnum):
    """
...
class CoverageLevel(GObject.GEnum, enum.IntEnum):
    """
...
class Direction(GObject.GEnum, enum.IntEnum):
    """
...
class EllipsizeMode(GObject.GEnum, enum.IntEnum):
    """
...
class FontMask(GObject.GFlags, enum.IntFlag):
    """
...
class FontScale(GObject.GEnum, enum.IntEnum):
    """
...
class Gravity(GObject.GEnum, enum.IntEnum):
    ...
    @staticmethod
    def get_for_script_and_width(script: Script, wide: bool, base_gravity: Gravity, hint: GravityHint) -> Gravity: ...
    @staticmethod
    def to_rotation(gravity: Gravity) -> float: ...

class GravityHint(GObject.GEnum, enum.IntEnum):
    """
...
class LayoutDeserializeError(GObject.GEnum, enum.IntEnum):
    """
...
class LayoutDeserializeFlags(GObject.GFlags, enum.IntFlag):
    """
...
class LayoutSerializeFlags(GObject.GFlags, enum.IntFlag):
    """
...
class Overline(GObject.GEnum, enum.IntEnum):
    """
...
class RenderPart(GObject.GEnum, enum.IntEnum):
    """
...
class Script(GObject.GEnum, enum.IntEnum):
    """
...
class ShapeFlags(GObject.GFlags, enum.IntFlag):
    """
...
class ShowFlags(GObject.GFlags, enum.IntFlag):
    """
...
class Stretch(GObject.GEnum, enum.IntEnum):
    """
...
class Style(GObject.GEnum, enum.IntEnum):
    """
...
class TabAlign(GObject.GEnum, enum.IntEnum):
    """
...
class TextTransform(GObject.GEnum, enum.IntEnum):
    """
...
class Underline(GObject.GEnum, enum.IntEnum):
    """
...
class Variant(GObject.GEnum, enum.IntEnum):
    """
...
class Weight(GObject.GEnum, enum.IntEnum):
    """
...
class WrapMode(GObject.GEnum, enum.IntEnum):
    """
...
class Coverage(GObject.Object):
    ...
    @deprecated("deprecated")
    @staticmethod
    def from_bytes(bytes: bytes) -> Coverage | None:
        """
...
class Font(GObject.Object):
    ...
    def describe_with_absolute_size(self) -> FontDescription:
        ...
        """
    @staticmethod
    def descriptions_free(descs: list[FontDescription] | None = None) -> None:
        """
...
class Fontset(GObject.Object):
    ...
    def do_foreach(
        self,
        func: collections.abc.Callable[[Fontset, Font, typing.Any], bool],
...
class GlyphItem(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        """
    def get_logical_widths(self, text: str, logical_widths: list[int]) -> None:
        """
...
class GlyphString(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def free(self) -> None:
        ...
        """
    def get_logical_widths(self, text: str, length: int, embedding_level: int, logical_widths: list[int]) -> None:
        """
...
class Language(GObject.GBoxed, metaclass=GObject.GType):
    ...
    def get_sample_string(self) -> str:
        ...
        ```
        """
    def get_scripts(self) -> tuple[list[Script] | None, int]:
        """
...
class Layout(GObject.Object):
    ...
    def get_log_attrs(self) -> list[LogAttr]:
        ...
        the `layout`.
        """
    def get_log_attrs_readonly(self) -> tuple[list[LogAttr], int]:
        """
            Retrieves an array of logical attributes for each character in
        the `layout`.
    ...
    def is_wrapped(self) -> bool:
        ...
        ellipsization mode of `layout` is set to Pango.ELLIPSIZE_NONE,
...
class AttrDataCopyFunc(typing.Protocol):
    """
    This callback was used in:
        AttrShape.copy_func, Pango.attr_shape_new_with_data, Pango.new_with_data
    """
    #  user_data
    def __call__(
        self,
